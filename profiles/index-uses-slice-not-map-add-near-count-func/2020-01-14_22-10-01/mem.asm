...
ROUTINE ======================== main.(*Graph).buildAdjList
  357.64MB   357.64MB (flat, cum) 44.75% of Total
   ...
   62.02MB    62.02MB    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
   ...
   66.01MB    66.01MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  229.60MB   229.60MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
      90MB       90MB (flat, cum) 11.26% of Total
      ...
      90MB       90MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  159.50MB   799.14MB (flat, cum)   100% of Total
   ...
   10.50MB    10.50MB    10c9d31: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  126.11MB   126.11MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .       90MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   357.64MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
         ...
         .          .    10ca1fe: INT $0x3
ROUTINE ======================== main.main
         0   799.14MB (flat, cum)   100% of Total
         ...
         .   799.14MB    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.03% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   799.14MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
