...
ROUTINE ======================== main.(*Graph).buildAdjList
  371.64MB   371.64MB (flat, cum) 45.53% of Total
   ...
   65.52MB    65.52MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  240.61MB   240.61MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
   ...
   92.50MB    92.50MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  158.90MB   815.04MB (flat, cum) 99.86% of Total
    ...
    8.50MB     8.50MB    10c9d31: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  127.51MB   127.51MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .    92.50MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   371.64MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
...
ROUTINE ======================== main.main
         ...
         .   815.04MB    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== runtime.main
         ...
         .   816.20MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
