...
ROUTINE ======================== main.(*Graph).EdgeCount
      10ms       10ms (flat, cum)  0.16% of Total
         .          .    10caef0: MOVQ 0x8(SP), AX                        ;graph.go:309
         .          .    10caef5: MOVQ 0x20(AX), CX
         .          .    10caef9: MOVQ 0x18(AX), AX
         .          .    10caefd: XORL DX, DX
         .          .    10caeff: XORL BX, BX
         .          .    10caf01: JMP 0x10caf16
         .          .    10caf03: LEAQ 0x1(DX), SI
         .          .    10caf07: LEAQ 0(DX)(DX*2), DI                    ;graph.go:310
         .          .    10caf0b: MOVQ 0x8(AX)(DI*8), DI
      10ms       10ms    10caf10: ADDQ DI, BX                             ;main.(*Graph).EdgeCount graph.go:310
         .          .    10caf13: MOVQ SI, DX                             ;graph.go:309
         .          .    10caf16: CMPQ CX, DX
         .          .    10caf19: JL 0x10caf03
         .          .    10caf1b: MOVQ BX, AX                             ;graph.go:313
         .          .    10caf1e: SHRQ $0x3f, BX
         .          .    10caf22: ADDQ BX, AX
         .          .    10caf25: SARQ $0x1, AX
         .          .    10caf28: MOVQ AX, 0x10(SP)
         .          .    10caf2d: RET
         .          .    10caf2e: INT $0x3
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     360ms      360ms    10ca288: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:109
         .          .    10ca28c: MOVQ 0x8(BX), R11                       ;graph.go:110
      10ms       10ms    10ca290: MOVQ 0(BX), R12                         ;main.(*Graph).buildAdjList graph.go:110
         .          .    10ca293: CMPQ R11, R10                           ;graph.go:110
      ...
      20ms       20ms    10ca2b9: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:110
         ...
         .       30ms    10ca2e0: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca31c: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca321: MOVQ 0(BX)(SI*8), R9                    ;graph.go:111
         ...
         .      270ms    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca4bc: MOVQ 0x60(SP), AX                       ;main.(*Graph).buildAdjList graph.go:103
         ...
         .      150ms    10ca548: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:105
         ...
         .      110ms    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
         ...
         .      590ms    10ca5bf: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
     110ms      770ms (flat, cum) 12.30% of Total
      ...
      10ms       10ms    10cbe2f: LEAQ 0x1(R8), R10                       ;main.(*index).add index.go:39
         .          .    10cbe33: MOVQ R10, 0x8(BX)(SI*8)                 ;index.go:39
         ...
         .          .    10cbe68: MOVQ R12, CX                            ;index.go:108
         .          .    10cbe6b: MOVQ R11, DX                            ;index.go:107
         .          .    10cbe6e: MOVQ 0xa0(SP), BX                       ;index.go:36
         .          .    10cbe76: MOVQ R9, SI                             ;index.go:108
         .          .    10cbe79: MOVQ R13, DI                            ;index.go:33
         .          .    10cbe7c: MOVQ R14, R8                            ;index.go:109
         .          .    10cbe7f: MOVQ R15, AX                            ;index.go:33
         .          .    10cbe82: CMPQ DI, AX
         .          .    10cbe85: JGE 0x10cc093
         .       30ms    10cbe8b: NOPL                                    ;main.(*index).add index.go:34
         .          .    10cbe8c: CMPQ DX, AX                             ;index.go:107
         .          .    10cbe8f: JA 0x10cc0b8
         .          .    10cbe95: CMPQ CX, AX                             ;index.go:108
         .          .    10cbe98: JA 0x10cc0b3
         .          .    10cbe9e: MOVQ AX, 0x48(SP)                       ;index.go:33
         .          .    10cbea3: SUBQ AX, CX                             ;index.go:108
         ...
         .          .    10cbec0: CMPQ R8, SI                             ;index.go:109
         .          .    10cbec3: JE 0x10cbed8
         .          .    10cbec5: MOVQ SI, 0(SP)
         .          .    10cbec9: MOVQ R8, 0x8(SP)
         .          .    10cbece: MOVQ AX, 0x10(SP)
         .       10ms    10cbed3: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:109
         .          .    10cbed8: MOVQ 0x48(SP), AX                       ;index.go:110
         .          .    10cbedd: INCQ AX
         ...
         .       40ms    10cbf91: CALL CX                                 ;main.(*index).add index.go:38
         ...
         .          .    10cbfb0: XORL DX, DX
         .          .    10cbfb2: DIVQ BX
      10ms       10ms    10cbfb5: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:39
      ...
      10ms       10ms    10cbfd4: MOVQ 0(BX)(SI*8), R9
         .          .    10cbfd8: LEAQ 0x1(R8), R10                       ;index.go:39
         ...
         .      560ms    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
         ...
         .          .    10cc07b: MOVQ R8, 0(SP)                          ;index.go:110
         .          .    10cc07f: MOVQ CX, 0x8(SP)
         .          .    10cc084: MOVQ BX, 0x10(SP)
         .       20ms    10cc089: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:110
         .          .    10cc08e: JMP 0x10cbf2a                           ;index.go:110
         ...
         .          .    10cc0b3: CALL runtime.panicSliceB(SB)            ;index.go:108
         .          .    10cc0b8: MOVQ AX, CX                             ;index.go:107
...
ROUTINE ======================== main.(*index).near
      50ms      600ms (flat, cum)  9.58% of Total
         ...
         .          .    10cc51f: CALL CX
         .          .    10cc521: MOVQ 0x218(SP), AX                      ;index.go:86
         ...
         .          .    10cc56f: MOVQ 0x28(CX), SI                       ;index.go:87
         ...
         .          .    10cc59e: MOVQ 0x220(SP), R9                      ;index.go:88
         .          .    10cc5a6: XORL AX, AX
         .          .    10cc5a8: JMP 0x10cc5ea
         .          .    10cc5aa: MOVQ AX, R10                            ;index.go:93
         .          .    10cc5ad: SHLQ $0x3, AX
         .          .    10cc5b1: MOVQ DX, 0x78(SP)(AX*1)
         .          .    10cc5b6: MOVQ 0x228(SP), R11                     ;index.go:88
         .          .    10cc5be: MOVQ 0x200(SP), R12
         .          .    10cc5c6: MOVQ 0x48(SP), R13
         .          .    10cc5cb: MOVQ 0x68(SP), R14
         .          .    10cc5d0: MOVQ 0x220(SP), R15
         .          .    10cc5d8: MOVQ R13, DX                            ;index.go:107
         .          .    10cc5db: MOVQ R12, SI                            ;index.go:108
         .          .    10cc5de: MOVQ R11, DI                            ;index.go:88
         .          .    10cc5e1: MOVQ R14, R8                            ;index.go:108
         .          .    10cc5e4: MOVQ R15, R9                            ;index.go:109
         .          .    10cc5e7: MOVQ R10, AX                            ;index.go:88
         .          .    10cc5ea: CMPQ DI, AX
         .          .    10cc5ed: JGE 0x10cc756
         .       10ms    10cc5f3: NOPL                                    ;main.(*index).near index.go:89
         .          .    10cc5f4: CMPQ DX, AX                             ;index.go:107
         .          .    10cc5f7: JA 0x10cc870
         .          .    10cc5fd: CMPQ R8, AX                             ;index.go:108
         .          .    10cc600: JA 0x10cc868
         .          .    10cc606: MOVQ AX, 0x40(SP)                       ;index.go:88
         .          .    10cc60b: SUBQ AX, R8                             ;index.go:108
         ...
         .       10ms    10cc6e9: CALL CX                                 ;main.(*index).near index.go:92
         .          .    10cc6eb: MOVQ 0x218(SP), AX                      ;index.go:93
         .          .    10cc6f3: MOVQ 0(AX), CX
         .          .    10cc6f6: MOVQ 0x8(AX), DX
         .          .    10cc6fa: MOVQ 0x38(CX), CX
         .          .    10cc6fe: MOVQ DX, 0(SP)
         .       30ms    10cc702: CALL CX                                 ;main.(*index).near index.go:93
         .          .    10cc704: MOVQ 0x8(SP), AX                        ;index.go:93
         ...
         .          .    10cc721: XORL DX, DX
         .          .    10cc723: DIVQ BX
      10ms       10ms    10cc726: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:93
         .          .    10cc72b: MOVQ 0x60(SP), BX                       ;index.go:93
         .          .    10cc730: CMPQ BX, AX
         .          .    10cc733: JB 0x10cc5aa
         .          .    10cc739: JMP 0x10cc85b
         .          .    10cc73e: MOVQ R8, 0(SP)                          ;index.go:110
         .          .    10cc742: MOVQ CX, 0x8(SP)
         .          .    10cc747: MOVQ BX, 0x10(SP)
         .       10ms    10cc74c: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:110
         .          .    10cc751: JMP 0x10cc698                           ;index.go:110
         .          .    10cc756: MOVQ 0x248(SP), DX                      ;index.go:97
         ...
         .          .    10cc775: INCQ AX
         .          .    10cc778: MOVQ R11, DX                            ;index.go:100
         .          .    10cc77b: MOVQ SI, R8
      10ms       10ms    10cc77e: MOVQ R10, SI                            ;main.(*index).near index.go:100
         .          .    10cc781: CMPQ BX, AX                             ;index.go:97
         .          .    10cc784: JGE 0x10cc835
         .          .    10cc78a: MOVQ 0x78(SP)(AX*8), R9                 ;index.go:98
         .          .    10cc78f: MOVQ 0x10(CX), R10                      ;index.go:99
      10ms       10ms    10cc793: MOVQ 0x18(CX), R11                      ;main.(*index).near index.go:99
         .          .    10cc797: CMPQ R11, R9                            ;index.go:99
         .          .    10cc79a: JAE 0x10cc850
         .          .    10cc7a0: LEAQ 0(R9)(R9*2), R9
         .          .    10cc7a4: MOVQ 0x8(R10)(R9*8), R11
         .          .    10cc7a9: MOVQ 0(R10)(R9*8), R9
         .          .    10cc7ad: CMPQ SI, R8                             ;index.go:100
         ...
         .          .    10cc7c3: MOVQ DX, R11
         .          .    10cc7c6: SUBQ R8, DX
      10ms       10ms    10cc7c9: NEGQ DX                                 ;main.(*index).near index.go:100
         .          .    10cc7cc: SHLQ $0x3, R8                           ;index.go:100
         .          .    10cc7d0: SARQ $0x3f, DX
         .          .    10cc7d4: ANDQ DX, R8
         .          .    10cc7d7: LEAQ 0(DI)(R8*1), DX
         .          .    10cc7db: CMPQ R9, DX
         .          .    10cc7de: JE 0x10cc775
      10ms       10ms    10cc7e0: MOVQ AX, 0x58(SP)                       ;main.(*index).near index.go:97
         .          .    10cc7e5: MOVQ SI, 0x50(SP)                       ;index.go:100
         .          .    10cc7ea: MOVQ DX, 0(SP)
         .          .    10cc7ee: MOVQ R9, 0x8(SP)
         .          .    10cc7f3: SHLQ $0x3, SI
         .          .    10cc7f7: MOVQ SI, 0x10(SP)
         .      490ms    10cc7fc: CALL runtime.memmove(SB)                ;main.(*index).near index.go:100
         .          .    10cc801: MOVQ 0x58(SP), AX                       ;index.go:97
         .          .    10cc806: MOVQ 0x218(SP), CX                      ;index.go:99
         .          .    10cc80e: MOVQ 0x60(SP), BX                       ;index.go:97
         .          .    10cc813: MOVQ 0x50(SP), SI                       ;index.go:100
...
ROUTINE ======================== main.(*index).nearCount
     110ms      150ms (flat, cum)  2.40% of Total
      ...
      10ms       10ms    10cc0f2: MOVQ BP, 0x1f8(SP)                      ;main.(*index).nearCount index.go:57
         .          .    10cc0fa: LEAQ 0x1f8(SP), BP                      ;index.go:57
      ...
      10ms       10ms    10cc1cc: MOVQ 0x50(SP), BX                       ;main.(*index).nearCount index.go:62
         ...
         .          .    10cc248: MOVQ R13, DX                            ;index.go:107
         .          .    10cc24b: MOVQ R12, SI                            ;index.go:108
         .          .    10cc24e: MOVQ R11, DI                            ;index.go:64
         .          .    10cc251: MOVQ R14, R8                            ;index.go:108
         .          .    10cc254: MOVQ R15, R9                            ;index.go:109
         .          .    10cc257: MOVQ R10, AX                            ;index.go:64
         .          .    10cc25a: CMPQ DI, AX
         .          .    10cc25d: JGE 0x10cc3c3
         .          .    10cc263: NOPL                                    ;index.go:65
         .          .    10cc264: CMPQ DX, AX                             ;index.go:107
         .          .    10cc267: JA 0x10cc429
         .          .    10cc26d: CMPQ R8, AX                             ;index.go:108
         .          .    10cc270: JA 0x10cc421
         .          .    10cc276: MOVQ AX, 0x40(SP)                       ;index.go:64
         .          .    10cc27b: SUBQ AX, R8                             ;index.go:108
      ...
      20ms       20ms    10cc329: MOVQ 0(AX), CX                          ;main.(*index).nearCount index.go:68
         .          .    10cc32c: MOVQ 0x8(AX), DX                        ;index.go:68
         ...
         .       10ms    10cc359: CALL CX                                 ;main.(*index).nearCount index.go:68
      10ms       10ms    10cc35b: MOVQ 0x208(SP), AX                      ;main.(*index).nearCount index.go:69
         .          .    10cc363: MOVQ 0(AX), CX                          ;index.go:69
         ...
         .          .    10cc38e: MOVQ DX, BX
      10ms       10ms    10cc391: XORL DX, DX                             ;main.(*index).nearCount index.go:69
         .          .    10cc393: DIVQ BX                                 ;index.go:69
      20ms       20ms    10cc396: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:69
         .          .    10cc39b: MOVQ 0x50(SP), BX                       ;index.go:69
         .          .    10cc3a0: CMPQ BX, AX
         .          .    10cc3a3: JB 0x10cc21a
         .          .    10cc3a9: JMP 0x10cc414
         .          .    10cc3ab: MOVQ R8, 0(SP)                          ;index.go:110
      ...
      20ms       20ms    10cc3d5: ADDQ SI, DX                             ;main.(*index).nearCount index.go:75
      10ms       10ms    10cc3d8: CMPQ BX, AX                             ;main.(*index).nearCount index.go:73
         .          .    10cc3db: JGE 0x10cc3f1                           ;index.go:73
         ...
         .          .    10cc421: MOVQ R8, CX                             ;index.go:108
         .          .    10cc424: CALL runtime.panicSliceB(SB)
         .          .    10cc429: MOVQ AX, CX                             ;index.go:107
...
ROUTINE ======================== main.LoadDictionary
      40ms      2.71s (flat, cum) 43.29% of Total
         ...
         .       40ms    10c9cee: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:54
         ...
         .       10ms    10c9d63: CALL runtime.memmove(SB)                ;main.LoadDictionary graph.go:57
      ...
      10ms       10ms    10c9efe: MOVQ $0x0, 0x8(DX)(CX*8)                ;main.LoadDictionary graph.go:70
         .          .    10c9f07: MOVQ $0x0, 0x10(DX)(CX*8)               ;graph.go:70
         ...
         .       80ms    10c9f6e: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
         ...
         .      740ms    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .      1.74s    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
...
ROUTINE ======================== main.distance
      ...
      20ms       20ms    10caea8: LEAQ 0x1(BX), R11                       ;main.distance graph.go:294
...
ROUTINE ======================== main.main
         ...
         .      2.71s    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .       10ms    10cca3e: CALL main.(*Graph).EdgeCount(SB)        ;main.main main.go:53
         .          .    10cca43: MOVQ 0x8(SP), AX                        ;main.go:53
         ...
         .          .    10ccb75: RET
         .       20ms    10ccb76: CALL runtime.GC(SB)                     ;main.main main.go:88
...
ROUTINE ======================== main.newIndex
      30ms       80ms (flat, cum)  1.28% of Total
         ...
         .       10ms    10cbbdb: CALL runtime.makeslice(SB)              ;main.newIndex index.go:17
         ...
         .       20ms    10cbc17: CALL runtime.makeslice(SB)              ;main.newIndex index.go:19
      ...
      10ms       10ms    10cbc41: LEAQ 0(BX)(CX*8), DI
         .          .    10cbc45: CMPL $0x0, runtime.writeBarrier(SB)     ;index.go:19
