...
ROUTINE ======================== main.(*Graph).buildAdjList
  351.14MB   351.14MB (flat, cum) 44.32% of Total
   ...
   65.52MB    65.52MB    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
   ...
   60.51MB    60.51MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  225.11MB   225.11MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
      95MB       95MB (flat, cum) 11.99% of Total
      ...
      95MB       95MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  154.16MB   792.30MB (flat, cum)   100% of Total
    ...
    6.50MB     6.50MB    10c9d31: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  124.77MB   124.77MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .       95MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   351.14MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
         ...
         .          .    10ca1fe: INT $0x3
ROUTINE ======================== main.main
         0   792.30MB (flat, cum)   100% of Total
         ...
         .   792.30MB    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.23% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   792.30MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
