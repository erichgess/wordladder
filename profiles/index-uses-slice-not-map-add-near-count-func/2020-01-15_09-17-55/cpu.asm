...
ROUTINE ======================== main.(*Graph).buildAdjList
     590ms      1.68s (flat, cum) 26.88% of Total
     ...
     480ms      480ms    10ca288: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:109
      ...
      90ms       90ms    10ca2b9: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:110
      10ms       10ms    10ca2be: MOVQ 0x8(R12)(AX*8), R8
         ...
         .       40ms    10ca2e0: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:110
         ...
         .      160ms    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
         ...
         .      110ms    10ca548: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:105
         ...
         .       90ms    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
         ...
         .      440ms    10ca5bf: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:108
         ...
         .       10ms    10ca600: XORPS X0, X0                            ;main.(*Graph).buildAdjList graph.go:116
         .          .    10ca603: CVTSI2SDQ CX, X0                        ;graph.go:116
         .          .    10ca608: XORPS X1, X1
         ...
         .       10ms    10ca690: CALL fmt.Fprintf(SB)                    ;fmt.Printf print.go:213
         .          .    10ca695: MOVQ 0xd8(SP), BP                       ;print.go:213
...
ROUTINE ======================== main.(*index).add
     140ms      760ms (flat, cum) 12.16% of Total
     ...
     110ms      110ms    10cbfcf: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:39
         ...
         .      550ms    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
         ...
         .          .    10cc07b: MOVQ R8, 0(SP)                          ;index.go:125
         .          .    10cc07f: MOVQ CX, 0x8(SP)
         .          .    10cc084: MOVQ BX, 0x10(SP)
         .       10ms    10cc089: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:125
         .          .    10cc08e: JMP 0x10cbf2a                           ;index.go:125
         ...
         .          .    10cc0b3: CALL runtime.panicSliceB(SB)            ;index.go:123
         .          .    10cc0b8: MOVQ AX, CX                             ;index.go:122
...
ROUTINE ======================== main.(*index).near
      10ms      440ms (flat, cum)  7.04% of Total
         ...
         .          .    10cc5d8: MOVQ R13, DX                            ;index.go:122
         .          .    10cc5db: MOVQ R12, SI                            ;index.go:123
         .          .    10cc5de: MOVQ R11, DI                            ;index.go:102
         .          .    10cc5e1: MOVQ R14, R8                            ;index.go:123
         .          .    10cc5e4: MOVQ R15, R9                            ;index.go:124
         .          .    10cc5e7: MOVQ R10, AX                            ;index.go:102
         .          .    10cc5ea: CMPQ DI, AX
         .          .    10cc5ed: JGE 0x10cc756
         .          .    10cc5f3: NOPL                                    ;index.go:103
         .          .    10cc5f4: CMPQ DX, AX                             ;index.go:122
         .          .    10cc5f7: JA 0x10cc870
         .          .    10cc5fd: CMPQ R8, AX                             ;index.go:123
         .          .    10cc600: JA 0x10cc868
         .          .    10cc606: MOVQ AX, 0x40(SP)                       ;index.go:102
         .          .    10cc60b: SUBQ AX, R8                             ;index.go:123
         ...
         .          .    10cc721: XORL DX, DX
         .          .    10cc723: DIVQ BX
      10ms       10ms    10cc726: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:107
         .          .    10cc72b: MOVQ 0x60(SP), BX                       ;index.go:107
         .          .    10cc730: CMPQ BX, AX
         .          .    10cc733: JB 0x10cc5aa
         .          .    10cc739: JMP 0x10cc85b
         .          .    10cc73e: MOVQ R8, 0(SP)                          ;index.go:125
         ...
         .          .    10cc775: INCQ AX
         .          .    10cc778: MOVQ R11, DX                            ;index.go:115
         .          .    10cc77b: MOVQ SI, R8
         .          .    10cc77e: MOVQ R10, SI
         ...
         .          .    10cc7ad: CMPQ SI, R8                             ;index.go:115
         ...
         .          .    10cc868: MOVQ R8, CX                             ;index.go:123
         .          .    10cc86b: CALL runtime.panicSliceB(SB)
         .          .    10cc870: MOVQ AX, CX                             ;index.go:122
...
ROUTINE ======================== main.(*index).nearCount
      60ms      110ms (flat, cum)  1.76% of Total
         ...
         .          .    10cc248: MOVQ R13, DX                            ;index.go:122
         .          .    10cc24b: MOVQ R12, SI                            ;index.go:123
         .          .    10cc24e: MOVQ R11, DI                            ;index.go:64
         .          .    10cc251: MOVQ R14, R8                            ;index.go:123
         .          .    10cc254: MOVQ R15, R9                            ;index.go:124
         .          .    10cc257: MOVQ R10, AX                            ;index.go:64
         .          .    10cc25a: CMPQ DI, AX
         .          .    10cc25d: JGE 0x10cc3c3
         .          .    10cc263: NOPL                                    ;index.go:65
         .          .    10cc264: CMPQ DX, AX                             ;index.go:122
         .          .    10cc267: JA 0x10cc429
         .          .    10cc26d: CMPQ R8, AX                             ;index.go:123
         .          .    10cc270: JA 0x10cc421
         .          .    10cc276: MOVQ AX, 0x40(SP)                       ;index.go:64
         .          .    10cc27b: SUBQ AX, R8                             ;index.go:123
         ...
         .       20ms    10cc31f: CALL CX                                 ;main.(*index).nearCount index.go:67
      ...
      20ms       20ms    10cc396: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:69
         ...
         .          .    10cc3ab: MOVQ R8, 0(SP)                          ;index.go:125
      ...
      40ms       40ms    10cc3d5: ADDQ SI, DX                             ;main.(*index).nearCount index.go:75
         ...
         .          .    10cc421: MOVQ R8, CX                             ;index.go:123
         .          .    10cc424: CALL runtime.panicSliceB(SB)
         .          .    10cc429: MOVQ AX, CX                             ;index.go:122
...
ROUTINE ======================== main.LoadDictionary
      30ms      2.71s (flat, cum) 43.36% of Total
         ...
         .       30ms    10c9cee: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:54
      ...
      10ms       10ms    10c9ec6: MOVQ AX, 0(SP)                          ;main.LoadDictionary graph.go:70
         .          .    10c9eca: XORPS X0, X0                            ;graph.go:70
         ...
         .      140ms    10c9f6e: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
      ...
      10ms       10ms    10c9fc5: MOVQ 0x8(BX), DX                        ;main.LoadDictionary graph.go:75
         .          .    10c9fc9: MOVQ 0(BX), DI                          ;graph.go:75
         ...
         .      750ms    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .      1.67s    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
...
ROUTINE ======================== main.distance
      40ms       40ms (flat, cum)  0.64% of Total
      ...
      30ms       30ms    10caea8: LEAQ 0x1(BX), R11                       ;main.distance graph.go:294
      ...
      10ms       10ms    10caebb: CMPQ SI, AX                             ;main.distance graph.go:293
         ...
         .          .    10caeee: INT $0x3
ROUTINE ======================== main.main
         0      2.71s (flat, cum) 43.36% of Total
         ...
         .          .    10ccb75: RET
         .          .    10ccb76: CALL runtime.GC(SB)                     ;main.go:88
...
ROUTINE ======================== main.newIndex
      80ms      160ms (flat, cum)  2.56% of Total
      ...
      10ms       10ms    10cbbee: LEAQ 0x1(AX), CX                        ;main.newIndex index.go:18
      ...
      60ms       60ms    10cbc38: MOVQ $0x0, 0x10(BX)(CX*8)               ;main.newIndex index.go:19
         ...
         .       30ms    10cbc5a: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:19
         .          .    10cbc5f: MOVQ CX, AX                             ;index.go:18
         .          .    10cbc62: JMP 0x10cbbee                           ;index.go:19
         .       10ms    10cbc64: NOPL                                    ;erichgess/wordladder/vendor/github.com/spaolacci/murmur3.New64 murmur64.go:18
         ...
         .       10ms    10cbc6c: CALL erichgess/wordladder/vendor/github.com/spaolacci/murmur3.New128WithSeed(SB)
         .          .    10cbc71: MOVQ 0x10(SP), AX                       ;murmur64.go:22
         ...
         .          .    10cbccd: MOVQ 0x8(SP), AX
                                                                          ;main.newIndex index.go:22
         .       10ms    10cbcd2: LEAQ go.itab.*erichgess/wordladder/vendor/github.com/spaolacci/murmur3.digest64,hash.Hash64(SB), CX
         .          .    10cbcd9: MOVQ CX, 0(AX)                          ;index.go:22
