...
ROUTINE ======================== main.(*Graph).buildAdjList
  342.65MB   342.65MB (flat, cum) 43.51% of Total
   ...
   63.03MB    63.03MB    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
   ...
   58.01MB    58.01MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  221.61MB   221.61MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
   ...
   95.50MB    95.50MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  156.24MB   786.39MB (flat, cum) 99.85% of Total
   ...
   11.50MB    11.50MB    10c9d31: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  121.85MB   121.85MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .    95.50MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   342.65MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
...
ROUTINE ======================== main.main
         ...
         .   786.39MB    10cc97f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .     1.16MB    10cd494: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:33
...
ROUTINE ======================== runtime.main
         ...
         .   787.55MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
