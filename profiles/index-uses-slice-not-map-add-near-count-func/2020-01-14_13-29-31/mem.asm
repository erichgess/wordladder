...
ROUTINE ======================== main.(*Graph).buildAdjList
  373.65MB   373.65MB (flat, cum) 45.40% of Total
   ...
   72.02MB    72.02MB    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
   ...
   56.51MB    56.51MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  245.11MB   245.11MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
   97.50MB    97.50MB (flat, cum) 11.85% of Total
   ...
   97.50MB    97.50MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  158.86MB   822.01MB (flat, cum) 99.88% of Total
  ...
  126.47MB   126.47MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .    97.50MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   373.65MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
         ...
         .          .    10ca1fe: INT $0x3
ROUTINE ======================== main.main
         0   822.01MB (flat, cum) 99.88% of Total
         ...
         .   822.01MB    10cc9ff: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .          .    10ccb55: RET
         .          .    10ccb56: CALL runtime.GC(SB)                     ;main.go:88
         ...
         .          .    10ccc7b: CALL runtime/pprof.writeHeapInternal(SB)
         .          .    10ccc80: MOVQ 0x28(SP), AX
         .          .    10ccc85: MOVQ 0x30(SP), CX
         .          .    10ccc8a: TESTQ AX, AX                            ;main.go:94
         .          .    10ccc8d: JE 0x10ccb40
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.33% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   822.01MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
