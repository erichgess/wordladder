...
ROUTINE ======================== main.(*Graph).buildAdjList
  354.64MB   354.64MB (flat, cum) 44.46% of Total
   ...
   58.52MB    58.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   63.51MB    63.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  232.61MB   232.61MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      90MB       90MB (flat, cum) 11.28% of Total
      ...
      90MB       90MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.LoadDictionary
  159.86MB   796.51MB (flat, cum) 99.86% of Total
    ...
    8.50MB     8.50MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  128.47MB   128.47MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   354.64MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   797.67MB (flat, cum)   100% of Total
         ...
         .   796.51MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.07% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   797.67MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
