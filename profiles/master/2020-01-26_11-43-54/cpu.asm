...
ROUTINE ======================== main.(*Graph).EdgeCount
      10ms       10ms (flat, cum)  0.18% of Total
         .          .    10cb390: MOVQ 0x8(SP), AX                        ;graph.go:310
         .          .    10cb395: MOVQ 0x20(AX), CX
         .          .    10cb399: MOVQ 0x18(AX), AX
         .          .    10cb39d: XORL DX, DX
         .          .    10cb39f: XORL BX, BX
         .          .    10cb3a1: JMP 0x10cb3b6
         .          .    10cb3a3: LEAQ 0x1(DX), SI
         .          .    10cb3a7: LEAQ 0(DX)(DX*2), DI                    ;graph.go:311
         .          .    10cb3ab: MOVQ 0x8(AX)(DI*8), DI
         .          .    10cb3b0: ADDQ DI, BX
      10ms       10ms    10cb3b3: MOVQ SI, DX                             ;main.(*Graph).EdgeCount graph.go:310
         .          .    10cb3b6: CMPQ CX, DX                             ;graph.go:310
         .          .    10cb3b9: JL 0x10cb3a3
         .          .    10cb3bb: MOVQ BX, AX                             ;graph.go:314
         .          .    10cb3be: SHRQ $0x3f, BX
         .          .    10cb3c2: ADDQ BX, AX
         .          .    10cb3c5: SARQ $0x1, AX
         .          .    10cb3c8: MOVQ AX, 0x10(SP)
         .          .    10cb3cd: RET
         .          .    10cb3ce: INT $0x3
ROUTINE ======================== main.(*Graph).buildAdjList
     610ms      1.67s (flat, cum) 30.04% of Total
      ...
      10ms       10ms    10ca6d8: MOVQ 0x88(SP), R10                      ;main.(*Graph).buildAdjList graph.go:110
         .          .    10ca6e0: LEAQ 0x1(R10), R9                       ;graph.go:110
         .          .    10ca6e4: MOVQ 0x78(SP), R10
         .          .    10ca6e9: MOVQ 0x70(SP), R11
         .          .    10ca6ee: MOVQ 0x98(SP), R12
         .          .    10ca6f6: MOVQ 0x68(SP), R13
         .          .    10ca6fb: MOVQ 0xc0(SP), R14
      10ms       10ms    10ca703: MOVQ R10, AX                            ;main.(*Graph).buildAdjList graph.go:110
     ...
     510ms      510ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      50ms       50ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
         ...
         .       80ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      150ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
      ...
      10ms       10ms    10ca961: MOVQ 0xe8(SP), DX                       ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca9b2: MOVQ DX, 0x70(SP)                       ;main.(*Graph).buildAdjList graph.go:105
         .          .    10ca9b7: MOVQ 0x8(SI)(CX*8), BX                  ;graph.go:105
         ...
         .      130ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .       50ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      530ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      50ms      610ms (flat, cum) 10.97% of Total
         ...
         .          .    10cc32b: NOPL                                    ;index.go:47
         .          .    10cc32c: CMPQ DX, AX                             ;index.go:135
         .          .    10cc32f: JA 0x10cc558
         .          .    10cc335: CMPQ CX, AX                             ;index.go:136
      ...
      10ms       10ms    10cc438: MOVQ 0xa0(SP), CX                       ;main.(*index).add index.go:51
      ...
      40ms       40ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:52
         ...
         .      560ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.(*index).near
      ...
      10ms       10ms    10cca5e: MOVQ 0x200(SP), R12                     ;main.(*index).near index.go:115
         .          .    10cca66: MOVQ 0x48(SP), R13                      ;index.go:115
         ...
         .       10ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:120
      ...
      10ms       10ms    10ccba9: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:120
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      30ms       30ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:120
      ...
      10ms       10ms    10ccc44: MOVQ 0x8(R10)(R9*8), R11                ;main.(*index).near index.go:126
         .          .    10ccc49: MOVQ 0(R10)(R9*8), R9                   ;index.go:126
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:128
         .          .    10ccc50: JA 0x10ccce5                            ;index.go:128
         .          .    10ccc56: MOVQ SI, R10
         .          .    10ccc59: SUBQ R8, SI
         .          .    10ccc5c: CMPQ R11, SI
         ...
         .      450ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:128
...
ROUTINE ======================== main.(*index).nearCount
      70ms      130ms (flat, cum)  2.34% of Total
         ...
         .       10ms    10cc62f: CALL CX                                 ;main.(*index).nearCount index.go:74
         ...
         .          .    10cc667: XORL DX, DX
         .          .    10cc669: DIVQ BX
      10ms       10ms    10cc66c: MOVQ 0x50(SP), BX                       ;main.(*index).nearCount index.go:75
         .          .    10cc671: TESTQ BX, BX                            ;index.go:75
         ...
         .          .    10cc7bf: CALL CX
         .          .    10cc7c1: MOVQ 0x208(SP), AX                      ;index.go:81
         ...
         .       30ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:81
         ...
         .       20ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:82
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      10ms       10ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:82
      ...
      50ms       50ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:88
...
ROUTINE ======================== main.LoadDictionary
      ...
      30ms       30ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
      ...
      10ms       10ms    10ca2b8: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:71
         .          .    10ca2bd: MOVQ 0x120(SP), AX                      ;graph.go:71
         ...
         .      610ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         .          .    10ca3d3: MOVQ 0x50(SP), AX                       ;graph.go:76
         .          .    10ca3d8: INCQ AX
      10ms       10ms    10ca3db: MOVQ 0x60(SP), CX                       ;main.LoadDictionary graph.go:76
         .          .    10ca3e0: CMPQ CX, AX                             ;graph.go:76
         ...
         .      1.67s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb318: CMPQ DX, CX                             ;main.distance graph.go:290
      ...
      10ms       10ms    10cb36c: MOVQ BX, 0x50(SP)                       ;main.distance graph.go:299
      10ms       10ms    10cb371: MOVQ 0x10(SP), BP
         .          .    10cb376: ADDQ $0x18, SP                          ;graph.go:299
         .          .    10cb37a: RET
...
ROUTINE ======================== main.main
         ...
         .      2.57s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
         ...
         .       10ms    10cdbdb: CALL main.(*Graph).EdgeCount(SB)        ;main.main main.go:56
         .          .    10cdbe0: MOVQ 0x8(SP), AX                        ;main.go:56
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc092: MOVQ BX, AX                             ;main.newIndex index.go:32
      ...
      10ms       10ms    10cc0ab: MOVQ AX, 0(SP)                          ;main.newIndex index.go:32
         .          .    10cc0af: XORPS X0, X0                            ;index.go:32
         .          .    10cc0b2: MOVUPS X0, 0x8(SP)
         .       30ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:32
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:32
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      30ms       30ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:32
         .          .    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)               ;index.go:32
...
ROUTINE ======================== runtime.main
         ...
         .      2.58s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
