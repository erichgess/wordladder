...
ROUTINE ======================== main.(*Graph).buildAdjList
  387.66MB   387.66MB (flat, cum) 46.26% of Total
   ...
   60.02MB    60.02MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   64.51MB    64.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  263.13MB   263.13MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
     ...
     103MB      103MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.LoadDictionary
  154.26MB   836.92MB (flat, cum) 99.87% of Total
       ...
       7MB        7MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  124.36MB   124.36MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .      103MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   387.66MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.main
         ...
         .   836.92MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
         ...
         .   578.66kB    10ce6ef: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:36
...
ROUTINE ======================== runtime.main
         ...
         .   837.49MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
