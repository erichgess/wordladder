...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     420ms      420ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      20ms       20ms    10ca744: MOVQ R10, 0x58(SP)                      ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca791: MOVQ 0xe8(SP), DX                       ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca799: MOVQ 0x18(DX), BX                       ;graph.go:112
      ...
      10ms       10ms    10ca7d6: LEAQ 0x1(R8), DI                        ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca7da: MOVQ DI, 0x8(BX)(SI*8)                  ;graph.go:112
         ...
         .      170ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      200ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      490ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      90ms      690ms (flat, cum) 12.61% of Total
         ...
         .       30ms    10cc3e1: CALL CX                                 ;main.(*index).add index.go:49
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      10ms       10ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:52
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:52
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      70ms       70ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:52
      10ms       10ms    10cc474: MOVQ 0(BX)(SI*8), R9
         .          .    10cc478: LEAQ 0x1(R8), R10                       ;index.go:52
         ...
         .      550ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.(*index).near
      20ms      490ms (flat, cum)  8.96% of Total
         ...
         .       10ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:118
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      10ms       10ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:120
      ...
      10ms       10ms    10ccc63: MOVQ DX, R11                            ;main.(*index).near index.go:128
         .          .    10ccc66: SUBQ R8, DX                             ;index.go:128
         .          .    10ccc69: NEGQ DX
         .          .    10ccc6c: SHLQ $0x3, R8
...
ROUTINE ======================== main.(*index).nearCount
      ...
      10ms       10ms    10cc806: MOVQ 0x8(AX), DX                        ;main.(*index).nearCount index.go:82
         .          .    10cc80a: MOVQ 0x38(CX), CX                       ;index.go:82
...
ROUTINE ======================== main.LoadDictionary
      50ms      2.72s (flat, cum) 49.73% of Total
         ...
         .       60ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
      ...
      40ms       40ms    10ca17b: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:59
      10ms       10ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      690ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.74s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb300: SUBQ $0x18, SP                          ;main.distance graph.go:284
         .          .    10cb304: MOVQ BP, 0x10(SP)                       ;graph.go:284
...
ROUTINE ======================== main.main
         ...
         .      2.72s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      40ms      100ms (flat, cum)  1.83% of Total
         ...
         .       40ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:32
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:32
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
      10ms       10ms    10cc0ca: MOVQ 0x38(SP), BX                       ;main.newIndex index.go:32
      10ms       10ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)
      20ms       20ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
...
ROUTINE ======================== runtime.main
         ...
         .      2.72s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
