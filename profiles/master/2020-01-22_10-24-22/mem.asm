...
ROUTINE ======================== main.(*Graph).buildAdjList
  334.64MB   334.64MB (flat, cum) 42.42% of Total
   ...
   52.02MB    52.02MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   57.51MB    57.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  225.11MB   225.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
     ...
     105MB      105MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.LoadDictionary
  156.15MB   787.79MB (flat, cum) 99.85% of Total
    ...
    9.50MB     9.50MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  123.76MB   123.76MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .      105MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   334.64MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.main
         ...
         .   787.79MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== runtime.main
         ...
         .   788.95MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
