...
ROUTINE ======================== main.(*Graph).buildAdjList
  380.65MB   380.65MB (flat, cum) 46.54% of Total
   ...
   65.52MB    65.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   58.51MB    58.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  256.62MB   256.62MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      90MB       90MB (flat, cum) 11.00% of Total
      ...
      90MB       90MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.LoadDictionary
  155.22MB   817.87MB (flat, cum)   100% of Total
    ...
    7.50MB     7.50MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  124.83MB   124.83MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       90MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   380.65MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   817.87MB (flat, cum)   100% of Total
         ...
         .   817.87MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.48% of Total
     ...
     192MB      192MB    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:30
...
ROUTINE ======================== runtime.main
         ...
         .   817.87MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
