...
ROUTINE ======================== main.(*Graph).buildAdjList
     530ms      1.85s (flat, cum) 33.04% of Total
         ...
         .          .    10ca716: MOVQ R12, SI
      10ms       10ms    10ca719: MOVQ R13, DI                            ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca71c: MOVQ R14, R8                            ;graph.go:110
         .          .    10ca71f: CMPQ AX, R9
         .          .    10ca722: JGE 0x10ca976
     380ms      380ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca776: MOVQ R8, 0x20(SP)                       ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca77b: MOVQ BX, 0x28(SP)                       ;graph.go:111
         .      190ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca7bc: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*Graph).buildAdjList graph.go:112
      ...
      10ms       10ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      150ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      160ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      200ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      120ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      500ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      80ms      580ms (flat, cum) 10.36% of Total
      ...
      10ms       10ms    10cc2e4: MOVQ 0x78(SP), R9                       ;main.(*index).add index.go:46
         .          .    10cc2e9: MOVQ 0x50(SP), R11                      ;index.go:46
      ...
      10ms       10ms    10cc3d5: MOVQ 0x8(AX), DX                        ;main.(*index).add index.go:49
         .          .    10cc3d9: MOVQ 0x20(CX), CX                       ;index.go:49
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      30ms       30ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:52
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:52
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      30ms       30ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:52
         ...
         .      500ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.(*index).near
      80ms      510ms (flat, cum)  9.11% of Total
         ...
         .       10ms    10cca93: NOPL                                    ;main.(*index).near index.go:116
         ...
         .          .    10ccb0f: SUBQ AX, CX
         .          .    10ccb12: NEGQ CX
      10ms       10ms    10ccb15: SARQ $0x3f, CX                          ;main.skipOneCopy index.go:138
         .          .    10ccb19: ANDQ AX, CX                             ;index.go:138
      ...
      10ms       10ms    10ccb68: MOVQ 0x200(SP), DX                      ;main.(*index).near index.go:119
         .          .    10ccb70: MOVQ DX, 0x8(SP)                        ;index.go:119
         ...
         .       30ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:120
         .          .    10ccba4: MOVQ 0x8(SP), AX                        ;index.go:120
      20ms       20ms    10ccba9: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:120
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:128
         ...
         .      380ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:128
...
ROUTINE ======================== main.(*index).nearCount
     130ms      210ms (flat, cum)  3.75% of Total
         ...
         .       10ms    10cc5b4: CALL 0x105866e                          ;main.(*index).nearCount index.go:71
         .          .    10cc5b9: MOVQ 0(BP), BP                          ;index.go:71
         ...
         .       10ms    10cc5ef: CALL CX                                 ;main.(*index).nearCount index.go:73
         ...
         .       10ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:78
         ...
         .       30ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:82
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      20ms       20ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:82
     ...
     110ms      110ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:88
...
ROUTINE ======================== main.LoadDictionary
      40ms      2.73s (flat, cum) 48.75% of Total
      ...
      10ms       10ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      110ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
      ...
      10ms       10ms    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)               ;main.LoadDictionary graph.go:71
         .          .    10ca2f6: LEAQ 0(DX)(CX*8), DI                    ;graph.go:71
         ...
         .      580ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.85s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     190ms      190ms (flat, cum)  3.39% of Total
         .          .    10cb300: SUBQ $0x18, SP                          ;graph.go:284
      10ms       10ms    10cb304: MOVQ BP, 0x10(SP)                       ;main.distance graph.go:284
         .          .    10cb309: LEAQ 0x10(SP), BP                       ;graph.go:284
      10ms       10ms    10cb30e: MOVQ 0x28(SP), CX                       ;main.distance graph.go:290
         .          .    10cb313: MOVQ 0x40(SP), DX                       ;graph.go:290
         .          .    10cb318: CMPQ DX, CX
     ...
     120ms      120ms    10cb348: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
      ...
      10ms       10ms    10cb35b: CMPQ SI, AX                             ;main.distance graph.go:294
         .          .    10cb35e: JAE 0x10cb383                           ;graph.go:294
         .          .    10cb360: MOVZX 0(R8)(AX*1), R9
         .          .    10cb365: CMPQ DI, AX
         .          .    10cb368: JB 0x10cb343
         .          .    10cb36a: JMP 0x10cb37b
         .          .    10cb36c: MOVQ BX, 0x50(SP)                       ;graph.go:299
      10ms       10ms    10cb371: MOVQ 0x10(SP), BP                       ;main.distance graph.go:299
         ...
         .          .    10cb38e: INT $0x3
ROUTINE ======================== main.main
         0      2.74s (flat, cum) 48.93% of Total
         ...
         .      2.73s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      60ms      120ms (flat, cum)  2.14% of Total
         ...
         .       20ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:32
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:32
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      10ms       10ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:32
      30ms       30ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
      20ms       20ms    10cc0e1: LEAQ 0(BX)(CX*8), DI
         .          .    10cc0e5: CMPL $0x0, runtime.writeBarrier(SB)     ;index.go:32
         ...
         .       20ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:32
...
ROUTINE ======================== runtime.main
         ...
         .      2.74s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
