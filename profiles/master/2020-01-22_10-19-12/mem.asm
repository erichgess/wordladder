...
ROUTINE ======================== main.(*Graph).buildAdjList
  349.64MB   349.64MB (flat, cum) 44.79% of Total
   ...
   70.51MB    70.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  219.11MB   219.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
   ...
   83.50MB    83.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:51
...
ROUTINE ======================== main.LoadDictionary
  ...
  122.87MB   122.87MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   349.64MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.main
         ...
         .   779.40MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== runtime.main
         ...
         .   780.56MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
