...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     550ms      550ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca82e: MOVQ R12, 0xb8(SP)                      ;main.(*Graph).buildAdjList graph.go:113
         .          .    10ca836: MOVQ DI, 0xb0(SP)                       ;graph.go:113
         ...
         .      510ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      90ms      660ms (flat, cum) 11.04% of Total
         ...
         .       10ms    10cc32b: NOPL                                    ;main.(*index).add index.go:46
      ...
      10ms       10ms    10cc3ff: MOVQ DX, 0x8(SP)                        ;main.(*index).add index.go:49
         .          .    10cc404: MOVQ 0x58(SP), BX                       ;index.go:49
         ...
         .       30ms    10cc431: CALL CX                                 ;main.(*index).add index.go:50
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
         .          .    10cc455: MOVQ 0x10(CX), BX                       ;index.go:51
         .          .    10cc459: MOVQ 0x18(CX), SI
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      70ms       70ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:51
         ...
         .      530ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:51
      ...
      10ms       10ms    10cc51f: MOVQ CX, 0x8(SP)                        ;main.skipOneCopy index.go:137
         .          .    10cc524: MOVQ BX, 0x10(SP)                       ;index.go:137
...
ROUTINE ======================== main.(*index).near
         ...
         .       10ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:118
         ...
         .          .    10ccc4d: CMPQ SI, R8                             ;index.go:127
         ...
         .      500ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:127
...
ROUTINE ======================== main.(*index).nearCount
      40ms       50ms (flat, cum)  0.84% of Total
         ...
         .          .    10cc7f9: CALL CX
         .          .    10cc7fb: MOVQ 0x208(SP), AX                      ;index.go:81
         .          .    10cc803: MOVQ 0(AX), CX
         .          .    10cc806: MOVQ 0x8(AX), DX
         .          .    10cc80a: MOVQ 0x38(CX), CX
         .          .    10cc80e: MOVQ DX, 0(SP)
         .       10ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:81
         .          .    10cc814: MOVQ 0x8(SP), AX                        ;index.go:81
      10ms       10ms    10cc819: MOVQ 0x208(SP), CX                      ;main.(*index).nearCount index.go:81
         .          .    10cc821: MOVQ 0x40(CX), DX                       ;index.go:81
         .          .    10cc825: TESTQ DX, DX
      ...
      30ms       30ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:87
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)                 ;main.LoadDictionary graph.go:59
      ...
      20ms       20ms    10ca2e4: MOVQ $0x0, 0x8(DX)(CX*8)                ;main.LoadDictionary graph.go:71
      10ms       10ms    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)
         ...
         .      650ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.89s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.main
         ...
         .      2.82s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      80ms      120ms (flat, cum)  2.01% of Total
         ...
         .       10ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:31
      10ms       10ms    10cc0bc: MOVQ 0x20(SP), AX
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX                    ;index.go:31
         .          .    10cc0c5: MOVQ 0x18(SP), DX
      10ms       10ms    10cc0ca: MOVQ 0x38(SP), BX                       ;main.newIndex index.go:31
      30ms       30ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)
      30ms       30ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
         ...
         .       10ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:31
...
ROUTINE ======================== runtime.main
         ...
         .      2.82s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
