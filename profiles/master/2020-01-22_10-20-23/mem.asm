...
ROUTINE ======================== main.(*Graph).buildAdjList
  367.65MB   367.65MB (flat, cum) 44.85% of Total
   ...
   72.52MB    72.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   65.51MB    65.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  229.62MB   229.62MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
  101.51MB   101.51MB (flat, cum) 12.38% of Total
  ...
  101.51MB   101.51MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:51
...
ROUTINE ======================== main.LoadDictionary
  157.42MB   818.58MB (flat, cum) 99.86% of Total
      ...
      10MB       10MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  124.53MB   124.53MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   101.51MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   367.65MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   819.74MB (flat, cum)   100% of Total
         ...
         .   818.58MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.42% of Total
     ...
     192MB      192MB    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:29
...
ROUTINE ======================== runtime.main
         ...
         .   819.74MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
