...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     490ms      490ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca825: MOVQ AX, 0(R8)(R10*8)                   ;main.(*Graph).buildAdjList graph.go:113
         .          .    10ca829: JMP 0x10ca6d8                           ;graph.go:113
         ...
         .      160ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      110ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      30ms      430ms (flat, cum)  7.82% of Total
         ...
         .       10ms    10cc3e1: CALL CX                                 ;main.(*index).add index.go:42
      ...
      30ms       30ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:45
         ...
         .      390ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.(*index).near
      30ms      540ms (flat, cum)  9.82% of Total
      ...
      20ms       20ms    10ccad0: MOVQ SI, 0(SP)                          ;main.skipOneCopy index.go:130
         .          .    10ccad4: MOVQ R9, 0x8(SP)                        ;index.go:130
         ...
         .       40ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:112
      ...
      10ms       10ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:113
         ...
         .          .    10ccc4d: CMPQ SI, R8                             ;index.go:121
         ...
         .      430ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:121
...
ROUTINE ======================== main.(*index).nearCount
     110ms      170ms (flat, cum)  3.09% of Total
      ...
      10ms       10ms    10cc5f1: MOVQ 0x208(SP), AX                      ;main.(*index).nearCount index.go:67
         ...
         .       10ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:71
      ...
      10ms       10ms    10cc71e: MOVQ R8, 0x38(SP)                       ;main.skipOneCopy index.go:129
         .          .    10cc723: SUBQ AX, DX                             ;index.go:129
         .          .    10cc726: NEGQ DX
         ...
         .       10ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:74
         ...
         .       30ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:75
         .          .    10cc814: MOVQ 0x8(SP), AX                        ;index.go:75
      10ms       10ms    10cc819: MOVQ 0x208(SP), CX                      ;main.(*index).nearCount index.go:75
         .          .    10cc821: MOVQ 0x40(CX), DX                       ;index.go:75
         .          .    10cc825: TESTQ DX, DX
         .          .    10cc828: JE 0x10cc8bc
         .          .    10cc82e: MOVQ DX, BX
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      30ms       30ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:75
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)
         ...
         .      1.80s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     110ms      110ms (flat, cum)  2.00% of Total
      ...
      20ms       20ms    10cb365: CMPQ DI, AX                             ;main.distance graph.go:294
         ...
         .          .    10cb38e: INT $0x3
ROUTINE ======================== main.main
         0      2.52s (flat, cum) 45.82% of Total
         ...
         .      2.48s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       30ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:25
