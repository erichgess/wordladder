...
ROUTINE ======================== main.(*Graph).buildAdjList
  358.65MB   358.65MB (flat, cum) 44.34% of Total
   ...
   68.52MB    68.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   62.01MB    62.01MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  228.11MB   228.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
   98.50MB    98.50MB (flat, cum) 12.18% of Total
   ...
   98.50MB    98.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.LoadDictionary
  157.97MB   807.12MB (flat, cum) 99.79% of Total
       ...
       9MB        9MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  126.08MB   126.08MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .    98.50MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   358.65MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   808.84MB (flat, cum)   100% of Total
         ...
         .   807.12MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
         ...
         .     1.72MB    10ce6ef: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:36
...
ROUTINE ======================== runtime.main
         ...
         .   808.84MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
