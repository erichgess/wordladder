...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     450ms      450ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      20ms       20ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .       40ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
...
ROUTINE ======================== main.(*index).add
      60ms      590ms (flat, cum) 10.99% of Total
      ...
      10ms       10ms    10cc3d2: MOVQ 0(AX), CX                          ;main.(*index).add index.go:48
         .          .    10cc3d5: MOVQ 0x8(AX), DX                        ;index.go:48
         .          .    10cc3d9: MOVQ 0x20(CX), CX
         .          .    10cc3dd: MOVQ DX, 0(SP)
         .          .    10cc3e1: CALL CX
      10ms       10ms    10cc3e3: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:49
         .          .    10cc3eb: MOVQ 0(AX), CX                          ;index.go:49
      ...
      30ms       30ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:51
         ...
         .      520ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:51
      ...
      10ms       10ms    10cc52e: JMP 0x10cc3ca                           ;main.skipOneCopy index.go:137
         .          .    10cc533: MOVQ 0x90(SP), BP                       ;index.go:137
...
ROUTINE ======================== main.(*index).near
      20ms      500ms (flat, cum)  9.31% of Total
         ...
         .       10ms    10cc9bf: CALL CX                                 ;main.(*index).near index.go:111
         ...
         .       10ms    10cca93: NOPL                                    ;main.(*index).near index.go:115
         ...
         .       10ms    10ccade: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:136
         ...
         .       20ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:119
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      10ms       10ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:119
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:127
         ...
         .      420ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:127
...
ROUTINE ======================== main.(*index).nearCount
      20ms       40ms (flat, cum)  0.74% of Total
         ...
         .       20ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:81
      ...
      10ms       10ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:87
      10ms       10ms    10cc878: CMPQ BX, AX                             ;main.(*index).nearCount index.go:85
         .          .    10cc87b: JGE 0x10cc891                           ;index.go:85
...
ROUTINE ======================== main.LoadDictionary
      40ms      2.39s (flat, cum) 44.51% of Total
         ...
         .       50ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
      ...
      10ms       10ms    10ca2e4: MOVQ $0x0, 0x8(DX)(CX*8)                ;main.LoadDictionary graph.go:71
         ...
         .      1.52s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     100ms      100ms (flat, cum)  1.86% of Total
      ...
      20ms       20ms    10cb371: MOVQ 0x10(SP), BP                       ;main.distance graph.go:299
...
ROUTINE ======================== main.main
         ...
         .      2.39s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      30ms       30ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:31
...
ROUTINE ======================== runtime.main
         ...
         .      2.39s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
