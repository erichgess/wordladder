...
ROUTINE ======================== main.(*Graph).buildAdjList
  377.66MB   377.66MB (flat, cum) 45.81% of Total
   ...
   57.53MB    57.53MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   77.02MB    77.02MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  243.11MB   243.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      96MB       96MB (flat, cum) 11.64% of Total
      ...
      96MB       96MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:51
...
ROUTINE ======================== main.LoadDictionary
  158.76MB   824.43MB (flat, cum)   100% of Total
  ...
  125.87MB   125.87MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       96MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   377.66MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   824.43MB (flat, cum)   100% of Total
         ...
         .   824.43MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.29% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   824.43MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
