...
ROUTINE ======================== main.(*index).add
     110ms      660ms (flat, cum) 12.36% of Total
         ...
         .       10ms    10cc418: CALL CX                                 ;main.(*index).add index.go:43
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      20ms       20ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:45
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:45
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      80ms       80ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:45
      10ms       10ms    10cc474: MOVQ 0(BX)(SI*8), R9
         ...
         .      540ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.(*index).near
      20ms      590ms (flat, cum) 11.05% of Total
         ...
         .       20ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:111
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:121
         ...
         .      530ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:121
      10ms       10ms    10ccca1: MOVQ 0x58(SP), AX                       ;main.(*index).near index.go:117
...
ROUTINE ======================== main.(*index).nearCount
      ...
      10ms       10ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:81
...
ROUTINE ======================== main.main
         ...
         .      2.68s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc0a4: LEAQ runtime.types+86176(SB), AX        ;main.newIndex index.go:25
         .          .    10cc0ab: MOVQ AX, 0(SP)                          ;index.go:25
         .          .    10cc0af: XORPS X0, X0
         .          .    10cc0b2: MOVUPS X0, 0x8(SP)
         .          .    10cc0b7: CALL runtime.makeslice(SB)
         .          .    10cc0bc: MOVQ 0x20(SP), AX
      10ms       10ms    10cc0c1: LEAQ 0(AX)(AX*2), CX                    ;main.newIndex index.go:25
         .          .    10cc0c5: MOVQ 0x18(SP), DX                       ;index.go:25
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      40ms       40ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:25
      30ms       30ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
         .          .    10cc0e1: LEAQ 0(BX)(CX*8), DI                    ;index.go:25
...
ROUTINE ======================== runtime.main
         ...
         .      2.68s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
