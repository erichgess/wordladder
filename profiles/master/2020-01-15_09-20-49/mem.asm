...
ROUTINE ======================== main.(*Graph).buildAdjList
  357.14MB   357.14MB (flat, cum) 45.10% of Total
   ...
   63.02MB    63.02MB    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
   ...
   71.01MB    71.01MB    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
  ...
  223.10MB   223.10MB    10ca56c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:107
...
ROUTINE ======================== main.(*index).add
      86MB       86MB (flat, cum) 10.86% of Total
      ...
      86MB       86MB    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.LoadDictionary
  155.58MB   790.72MB (flat, cum) 99.85% of Total
       ...
       7MB        7MB    10c9d31: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  125.69MB   125.69MB    10c9dfa: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10c9e72: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .       86MB    10c9fe4: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   357.14MB    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
         ...
         .          .    10ca1fe: INT $0x3
ROUTINE ======================== main.main
         0   791.88MB (flat, cum)   100% of Total
         ...
         .   790.72MB    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .     1.16MB    10cd534: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:33
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.25% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   791.88MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
