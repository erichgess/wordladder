...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     480ms      480ms    10ca288: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:109
      ...
      10ms       10ms    10ca2d6: MOVQ R8, 0x20(SP)                       ;main.(*Graph).buildAdjList graph.go:110
      10ms       10ms    10ca2db: MOVQ BX, 0x28(SP)
         .       70ms    10ca2e0: CALL main.distance(SB)
      ...
      20ms       20ms    10ca365: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:112
      10ms       10ms    10ca36a: MOVQ 0x8(DI)(BX*8), R10
         ...
         .      160ms    10ca3bd: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      130ms    10ca454: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:111
...
ROUTINE ======================== main.(*index).add
     100ms      740ms (flat, cum) 13.01% of Total
         ...
         .          .    10cbf41: CALL CX
      10ms       10ms    10cbf43: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:37
         .          .    10cbf4b: MOVQ 0(AX), CX                          ;index.go:37
      ...
      80ms       80ms    10cbfcf: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:39
         ...
         .      630ms    10cc01d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:39
...
ROUTINE ======================== main.(*index).near
      10ms      590ms (flat, cum) 10.37% of Total
         ...
         .       20ms    10cc6e9: CALL CX                                 ;main.(*index).near index.go:106
         ...
         .       10ms    10cc702: CALL CX                                 ;main.(*index).near index.go:107
         .          .    10cc704: MOVQ 0x8(SP), AX                        ;index.go:107
      ...
      10ms       10ms    10cc726: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:107
         ...
         .      540ms    10cc7fc: CALL runtime.memmove(SB)                ;main.(*index).near index.go:115
...
ROUTINE ======================== main.(*index).nearCount
     100ms      170ms (flat, cum)  2.99% of Total
      ...
      10ms       10ms    10cc1cc: MOVQ 0x50(SP), BX                       ;main.(*index).nearCount index.go:62
         ...
         .          .    10cc283: SUBQ AX, DX
         .          .    10cc286: NEGQ DX
      10ms       10ms    10cc289: SARQ $0x3f, DX                          ;main.skipOneCopy index.go:123
      10ms       10ms    10cc28d: ANDQ AX, DX
         .          .    10cc290: ADDQ SI, DX                             ;index.go:123
      ...
      10ms       10ms    10cc334: MOVQ DX, 0(SP)                          ;main.(*index).nearCount index.go:68
         .          .    10cc338: MOVQ 0x1f0(SP), DX                      ;index.go:68
      ...
      30ms       30ms    10cc3d5: ADDQ SI, DX                             ;main.(*index).nearCount index.go:75
...
ROUTINE ======================== main.LoadDictionary
      ...
      20ms       20ms    10c9d95: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:58
      10ms       10ms    10c9d9a: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      110ms    10c9f6e: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
         ...
         .      1.82s    10ca047: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:87
...
ROUTINE ======================== main.distance
      ...
      40ms       40ms    10caea8: LEAQ 0x1(BX), R11                       ;main.distance graph.go:294
         .          .    10caeac: CMPL R10, R9                            ;graph.go:293
         .          .    10caeaf: CMOVNE R11, BX                          ;graph.go:294
      10ms       10ms    10caeb3: INCQ AX                                 ;main.distance graph.go:292
...
ROUTINE ======================== main.main
         ...
         .      2.79s    10cca1f: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cbba0: MOVQ GS:0x30, CX                        ;main.newIndex index.go:16
         ...
         .       60ms    10cbc17: CALL runtime.makeslice(SB)              ;main.newIndex index.go:19
...
ROUTINE ======================== runtime.main
         ...
         .      2.79s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
