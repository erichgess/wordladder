...
ROUTINE ======================== main.(*Graph).buildAdjList
  361.13MB   361.13MB (flat, cum) 44.72% of Total
   ...
   60.52MB    60.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   71.01MB    71.01MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  229.60MB   229.60MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      97MB       97MB (flat, cum) 12.01% of Total
      ...
      97MB       97MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.LoadDictionary
  156.24MB   806.37MB (flat, cum) 99.86% of Total
  ...
  123.84MB   123.84MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       97MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   361.13MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   807.53MB (flat, cum)   100% of Total
         ...
         .   806.37MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.78% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   807.53MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
