...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     530ms      530ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      20ms       20ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca829: JMP 0x10ca6d8                           ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      180ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
...
ROUTINE ======================== main.(*index).add
      90ms      690ms (flat, cum) 12.48% of Total
      ...
      10ms       10ms    10cc29f: MOVQ 0xb8(SP), DI                       ;main.(*index).add index.go:38
         .          .    10cc2a7: LEAQ -0x1(DI), CX                       ;index.go:38
         .          .    10cc2ab: CMPQ DX, CX
         ...
         .       10ms    10cc32b: NOPL                                    ;main.(*index).add index.go:40
         .          .    10cc32c: CMPQ DX, AX                             ;index.go:128
         .          .    10cc32f: JA 0x10cc558
      10ms       10ms    10cc335: CMPQ CX, AX                             ;main.skipOneCopy index.go:129
         .          .    10cc338: JA 0x10cc553                            ;index.go:129
         ...
         .          .    10cc3e1: CALL CX
      10ms       10ms    10cc3e3: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:43
         .          .    10cc3eb: MOVQ 0(AX), CX                          ;index.go:43
         ...
         .       20ms    10cc418: CALL CX                                 ;main.(*index).add index.go:43
         .          .    10cc41a: MOVQ 0xa0(SP), AX                       ;index.go:44
         .          .    10cc422: MOVQ 0(AX), CX
         .          .    10cc425: MOVQ 0x8(AX), DX
         .          .    10cc429: MOVQ 0x38(CX), CX
         .          .    10cc42d: MOVQ DX, 0(SP)
         .       10ms    10cc431: CALL CX                                 ;main.(*index).add index.go:44
         .          .    10cc433: MOVQ 0x8(SP), AX                        ;index.go:44
      10ms       10ms    10cc438: MOVQ 0xa0(SP), CX                       ;main.(*index).add index.go:44
         .          .    10cc440: MOVQ 0x40(CX), DX                       ;index.go:44
         .          .    10cc444: TESTQ DX, DX
         .          .    10cc447: JE 0x10cc54e
         .          .    10cc44d: MOVQ DX, BX
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      10ms       10ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:45
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:45
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      20ms       20ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:45
      10ms       10ms    10cc474: MOVQ 0(BX)(SI*8), R9
         .          .    10cc478: LEAQ 0x1(R8), R10                       ;index.go:45
         ...
         .      560ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
      ...
      10ms       10ms    10cc4e3: CMPL $0x0, runtime.writeBarrier(SB)     ;main.(*index).add index.go:45
         .          .    10cc4ea: JNE 0x10cc50c                           ;index.go:45
...
ROUTINE ======================== main.(*index).near
      50ms      610ms (flat, cum) 11.03% of Total
         ...
         .       10ms    10cc97f: CALL CX                                 ;main.(*index).near index.go:104
         ...
         .       10ms    10cc9bf: CALL CX                                 ;main.(*index).near index.go:105
         ...
         .       20ms    10cca93: NOPL                                    ;main.(*index).near index.go:109
      ...
      10ms       10ms    10ccb0f: SUBQ AX, CX                             ;main.skipOneCopy index.go:131
         .          .    10ccb12: NEGQ CX                                 ;index.go:131
         ...
         .       20ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:112
         ...
         .       20ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:113
      ...
      10ms       10ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:113
         ...
         .       10ms    10ccbec: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:131
         .          .    10ccbf1: JMP 0x10ccb38                           ;index.go:131
      ...
      20ms       20ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:121
         ...
         .      460ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:121
      ...
      10ms       10ms    10cccc8: MOVQ 0x248(SP), R11                     ;main.(*index).near index.go:121
         .          .    10cccd0: JMP 0x10ccc15                           ;index.go:121
...
ROUTINE ======================== main.(*index).nearCount
      90ms      210ms (flat, cum)  3.80% of Total
      ...
      10ms       10ms    10cc5a7: XORPS X0, X0                            ;main.(*index).nearCount index.go:64
         .          .    10cc5aa: MOVQ BP, -0x10(SP)                      ;index.go:64
         .          .    10cc5af: LEAQ -0x10(SP), BP
         .       10ms    10cc5b4: CALL 0x105866e                          ;main.(*index).nearCount index.go:64
         .          .    10cc5b9: MOVQ 0(BP), BP                          ;index.go:64
         ...
         .          .    10cc5ef: CALL CX
      10ms       10ms    10cc5f1: MOVQ 0x208(SP), AX                      ;main.(*index).nearCount index.go:67
         .          .    10cc5f9: MOVQ 0(AX), CX                          ;index.go:67
         ...
         .       20ms    10cc648: CALL CX                                 ;main.(*index).nearCount index.go:68
         .          .    10cc64a: MOVQ 0x8(SP), AX                        ;index.go:68
      ...
      10ms       10ms    10cc6ce: MOVQ 0x1f0(SP), R12                     ;main.(*index).nearCount index.go:70
         .          .    10cc6d6: MOVQ 0x48(SP), R13                      ;index.go:70
         ...
         .       20ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:71
         ...
         .       10ms    10cc74e: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:130
         ...
         .       20ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:74
         ...
         .       20ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:75
      ...
      10ms       10ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:75
         ...
         .       10ms    10cc859: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:131
         .          .    10cc85e: JMP 0x10cc7a8                           ;index.go:131
         .          .    10cc863: XORL AX, AX
         .          .    10cc865: XORL DX, DX
      ...
      50ms       50ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:81
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca17b: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:59
         ...
         .       60ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
      ...
      10ms       10ms    10ca2e4: MOVQ $0x0, 0x8(DX)(CX*8)                ;main.LoadDictionary graph.go:71
         .          .    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)               ;graph.go:71
         ...
         .      680ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.83s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb365: CMPQ DI, AX                             ;main.distance graph.go:294
         ...
         .          .    10cb38e: INT $0x3
ROUTINE ======================== main.main
         0      2.77s (flat, cum) 50.09% of Total
         ...
         .          .    10cdd2b: RET
         .       20ms    10cdd2c: CALL runtime.GC(SB)                     ;main.main main.go:97
...
ROUTINE ======================== main.newIndex
      80ms      120ms (flat, cum)  2.17% of Total
         ...
         .       10ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:23
      ...
      10ms       10ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:25
      10ms       10ms    10cc0bc: MOVQ 0x20(SP), AX
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX                    ;index.go:25
      ...
      20ms       20ms    10cc0e1: LEAQ 0(BX)(CX*8), DI
         ...
         .       10ms    10cc104: NOPL                                    ;erichgess/wordladder/vendor/github.com/spaolacci/murmur3.New64 murmur64.go:18
         .          .    10cc105: MOVL $0x0, 0(SP)                        ;murmur64.go:22
                                                                          ;erichgess/wordladder/vendor/github.com/spaolacci/murmur3.New64WithSeed murmur64.go:22
         .       10ms    10cc10c: CALL erichgess/wordladder/vendor/github.com/spaolacci/murmur3.New128WithSeed(SB)
         .          .    10cc111: MOVQ 0x10(SP), AX                       ;murmur64.go:22
         ...
         .          .    10cc16d: MOVQ 0x8(SP), AX
                                                                          ;main.newIndex index.go:28
         .       10ms    10cc172: LEAQ go.itab.*erichgess/wordladder/vendor/github.com/spaolacci/murmur3.digest64,hash.Hash64(SB), CX
         .          .    10cc179: MOVQ CX, 0(AX)                          ;index.go:28
...
ROUTINE ======================== runtime.main
         ...
         .      2.75s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
