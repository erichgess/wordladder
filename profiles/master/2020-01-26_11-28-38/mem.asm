...
ROUTINE ======================== main.(*Graph).buildAdjList
  370.14MB   370.14MB (flat, cum) 45.60% of Total
   ...
   73.02MB    73.02MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   61.51MB    61.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  235.61MB   235.61MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      93MB       93MB (flat, cum) 11.46% of Total
      ...
      93MB       93MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.LoadDictionary
  156.05MB   811.19MB (flat, cum) 99.94% of Total
       ...
       8MB        8MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  125.16MB   125.16MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       93MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   370.14MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   811.19MB (flat, cum) 99.94% of Total
         ...
         .   811.19MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.65% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   811.19MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
