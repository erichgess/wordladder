...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     100ms      100ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms      170ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca829: JMP 0x10ca6d8                           ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      110ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
      ...
      10ms       10ms    10ca8cd: MOVQ R11, 0xa0(SP)                      ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca8d5: LEAQ runtime.types+86176(SB), AX        ;graph.go:112
         .          .    10ca8dc: MOVQ AX, 0(SP)
         .          .    10ca8e0: MOVQ R9, 0x8(SP)
         .          .    10ca8e5: MOVQ R8, 0x10(SP)
         .          .    10ca8ea: MOVQ DI, 0x18(SP)
         .          .    10ca8ef: MOVQ R10, 0x20(SP)
         .      190ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
      ...
      10ms       10ms    10ca95c: MOVQ 0x60(SP), AX                       ;main.(*Graph).buildAdjList graph.go:104
         ...
         .      100ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      560ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      50ms      430ms (flat, cum)  8.10% of Total
         ...
         .       10ms    10cc32b: NOPL                                    ;main.(*index).add index.go:47
      ...
      10ms       10ms    10cc369: MOVQ R8, 0x8(SP)                        ;main.skipOneCopy index.go:137
         .          .    10cc36e: MOVQ AX, 0x10(SP)                       ;index.go:137
      ...
      40ms       40ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:52
         ...
         .      370ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.(*index).near
      70ms      580ms (flat, cum) 10.92% of Total
      10ms       10ms    10cc900: MOVQ GS:0x30, CX                        ;main.(*index).near index.go:108
         .          .    10cc909: LEAQ 0xfffffe70(SP), AX                 ;index.go:108
         ...
         .       20ms    10cca93: NOPL                                    ;main.(*index).near index.go:116
      ...
      10ms       10ms    10ccb47: MOVQ 0x20(CX), CX                       ;main.(*index).near index.go:118
         .          .    10ccb4b: MOVQ DX, 0(SP)                          ;index.go:118
         .          .    10ccb4f: CALL CX
         ...
         .       20ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:119
      ...
      30ms       30ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:120
         ...
         .       10ms    10ccbec: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:138
         .          .    10ccbf1: JMP 0x10ccb38                           ;index.go:138
      ...
      10ms       10ms    10ccc93: SHLQ $0x3, SI                           ;main.(*index).near index.go:128
         .          .    10ccc97: MOVQ SI, 0x10(SP)                       ;index.go:128
         .      460ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:128
...
ROUTINE ======================== main.(*index).nearCount
      40ms      100ms (flat, cum)  1.88% of Total
         ...
         .       10ms    10cc7bf: CALL CX                                 ;main.(*index).nearCount index.go:80
         ...
         .       40ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:82
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
         .          .    10cc836: MOVQ 0x60(SP), AX
         .          .    10cc83b: MOVQ 0x50(SP), BX
         .          .    10cc840: CMPQ BX, AX
      ...
      40ms       40ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:88
...
ROUTINE ======================== main.LoadDictionary
         ...
         .      140ms    10ca358: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
         ...
         .      420ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.81s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     160ms      160ms (flat, cum)  3.01% of Total
      ...
      20ms       20ms    10cb304: MOVQ BP, 0x10(SP)                       ;main.distance graph.go:284
      ...
      10ms       10ms    10cb31b: MOVQ CX, BX                             ;main.distance graph.go:293
         .          .    10cb31e: CMOVG DX, CX                            ;graph.go:293
      ...
      10ms       10ms    10cb33a: MOVQ 0x20(SP), R8                       ;main.distance graph.go:286
         .          .    10cb33f: XORL AX, AX                             ;graph.go:286
      ...
      30ms       30ms    10cb34f: CMOVNE R11, BX                          ;main.distance graph.go:295
...
ROUTINE ======================== main.main
         ...
         .      2.49s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
         ...
         .          .    10cdd2b: RET
         .       30ms    10cdd2c: CALL runtime.GC(SB)                     ;main.main main.go:97
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc040: MOVQ GS:0x30, CX                        ;main.newIndex index.go:29
         .          .    10cc049: CMPQ 0x10(CX), SP                       ;index.go:29
         ...
         .       70ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:30
      ...
      10ms       10ms    10cc0bc: MOVQ 0x20(SP), AX
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX                    ;index.go:32
         ...
         .       30ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:32
...
ROUTINE ======================== runtime.main
         ...
         .      2.52s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
