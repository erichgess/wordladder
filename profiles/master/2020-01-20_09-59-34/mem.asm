...
ROUTINE ======================== main.(*Graph).buildAdjList
  362.14MB   362.14MB (flat, cum) 44.55% of Total
   ...
   60.02MB    60.02MB    10ca80d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:114
   ...
   68.51MB    68.51MB    10ca8a4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
  ...
  233.61MB   233.61MB    10ca9bc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
  ...
  105.50MB   105.50MB    10cc46d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.LoadDictionary
  ...
  125.38MB   125.38MB    10ca215: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca28d: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   105.50MB    10ca403: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   362.14MB    10ca476: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:89
...
ROUTINE ======================== main.main
         ...
         .   812.91MB    10cd6ee: CALL main.LoadDictionary(SB)            ;main.main main.go:53
...
ROUTINE ======================== runtime.main
         ...
         .   812.91MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
