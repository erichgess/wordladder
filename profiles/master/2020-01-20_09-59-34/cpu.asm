...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     490ms      490ms    10ca6d8: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms      100ms    10ca730: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:112
      ...
      10ms       10ms    10ca7ba: MOVQ 0x8(DI)(BX*8), R10                 ;main.(*Graph).buildAdjList graph.go:114
         .          .    10ca7bf: LEAQ 0x1(R10), R11                      ;graph.go:114
      ...
      10ms       10ms    10ca7d9: JMP 0x10ca688                           ;main.(*Graph).buildAdjList graph.go:114
         .          .    10ca7de: MOVQ R12, 0xb8(SP)                      ;graph.go:114
         ...
         .      150ms    10ca80d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:114
         ...
         .      160ms    10ca8a4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
      ...
      10ms       10ms    10ca962: MOVQ DX, 0x70(SP)                       ;main.(*Graph).buildAdjList graph.go:106
         .          .    10ca967: MOVQ 0x8(SI)(CX*8), BX                  ;graph.go:106
         ...
         .      140ms    10ca998: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:107
         ...
         .      170ms    10ca9bc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:109
         ...
         .      610ms    10caa0f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:110
...
ROUTINE ======================== main.(*index).add
      20ms      380ms (flat, cum)  6.95% of Total
         ...
         .       10ms    10cc3c8: CALL CX                                 ;main.(*index).add index.go:39
      10ms       10ms    10cc3ca: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:40
      ...
      10ms       10ms    10cc41f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:41
         .          .    10cc424: MOVQ 0(BX)(SI*8), R9                    ;index.go:41
         ...
         .      350ms    10cc46d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.(*index).near
      50ms      610ms (flat, cum) 11.15% of Total
         ...
         .       10ms    10cc8f4: CALL 0x105866e                          ;main.(*index).near index.go:98
         .          .    10cc8f9: MOVQ 0(BP), BP                          ;index.go:98
         ...
         .          .    10ccaff: CALL CX
      10ms       10ms    10ccb01: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:108
         .          .    10ccb09: MOVQ 0(AX), CX                          ;index.go:108
         ...
         .       30ms    10ccb39: CALL CX                                 ;main.(*index).near index.go:108
         .          .    10ccb3b: MOVQ 0x218(SP), AX                      ;index.go:109
         .          .    10ccb43: MOVQ 0(AX), CX
         .          .    10ccb46: MOVQ 0x8(AX), DX
         .          .    10ccb4a: MOVQ 0x38(CX), CX
         .          .    10ccb4e: MOVQ DX, 0(SP)
         .       40ms    10ccb52: CALL CX                                 ;main.(*index).near index.go:109
         ...
         .          .    10ccb71: XORL DX, DX
         .          .    10ccb73: DIVQ BX
      30ms       30ms    10ccb76: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:109
      ...
      10ms       10ms    10ccbfd: CMPQ SI, R8                             ;main.(*index).near index.go:117
         .          .    10ccc00: JA 0x10ccc95                            ;index.go:117
         .          .    10ccc06: MOVQ SI, R10
         .          .    10ccc09: SUBQ R8, SI
         .          .    10ccc0c: CMPQ R11, SI
         ...
         .      480ms    10ccc4c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:117
...
ROUTINE ======================== main.(*index).nearCount
      80ms      160ms (flat, cum)  2.93% of Total
         ...
         .       20ms    10cc6b3: NOPL                                    ;main.(*index).nearCount index.go:67
      10ms       10ms    10cc6b4: CMPQ DX, AX                             ;main.skipOneCopy index.go:124
         .          .    10cc6b7: JA 0x10cc879                            ;index.go:124
         ...
         .       10ms    10cc6fe: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:126
         ...
         .       30ms    10cc7a9: CALL CX                                 ;main.(*index).nearCount index.go:70
         ...
         .       20ms    10cc7c2: CALL CX                                 ;main.(*index).nearCount index.go:71
         ...
         .          .    10cc7e1: XORL DX, DX
         .          .    10cc7e3: DIVQ BX
         .          .    10cc7e6: MOVQ 0x60(SP), AX
         .          .    10cc7eb: MOVQ 0x50(SP), BX
         .          .    10cc7f0: CMPQ BX, AX
         ...
         .          .    10cc809: CALL runtime.memmove(SB)
         .          .    10cc80e: JMP 0x10cc758
         .          .    10cc813: XORL AX, AX
         .          .    10cc815: XORL DX, DX
      ...
      70ms       70ms    10cc825: ADDQ SI, DX                             ;main.(*index).nearCount index.go:77
...
ROUTINE ======================== main.LoadDictionary
         ...
         .       40ms    10ca109: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
         ...
         .       10ms    10ca14c: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
         ...
         .       40ms    10ca215: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
         ...
         .       10ms    10ca344: CALL runtime.gcWriteBarrier(SB)         ;main.LoadDictionary graph.go:71
         ...
         .      100ms    10ca38d: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
         ...
         .      380ms    10ca403: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.90s    10ca476: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:89
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb2b4: MOVQ BP, 0x10(SP)                       ;main.distance graph.go:285
         .          .    10cb2b9: LEAQ 0x10(SP), BP                       ;graph.go:285
      ...
      10ms       10ms    10cb2cb: MOVQ CX, BX                             ;main.distance graph.go:294
         ...
         .          .    10cb2db: SUBQ SI, DX
         .          .    10cb2de: TESTQ BX, BX                            ;graph.go:287
      ...
      60ms       60ms    10cb2f8: LEAQ 0x1(BX), R11                       ;main.distance graph.go:296
         .          .    10cb2fc: CMPL R10, R9                            ;graph.go:295
         .          .    10cb2ff: CMOVNE R11, BX                          ;graph.go:296
         .          .    10cb303: INCQ AX                                 ;graph.go:294
         .          .    10cb306: CMPQ CX, AX
      ...
      10ms       10ms    10cb315: CMPQ DI, AX                             ;main.distance graph.go:295
         ...
         .          .    10cb321: MOVQ 0x10(SP), BP
         .          .    10cb326: ADDQ $0x18, SP
         .          .    10cb32a: RET
         ...
         .          .    10cb33e: INT $0x3
ROUTINE ======================== main.main
         0      2.53s (flat, cum) 46.25% of Total
         ...
         .      2.49s    10cd6ee: CALL main.LoadDictionary(SB)            ;main.main main.go:53
         ...
         .       10ms    10cd725: CALL runtime.convT64(SB)                ;main.main main.go:54
         .          .    10cd72a: MOVQ 0x8(SP), AX                        ;main.go:54
...
ROUTINE ======================== main.newIndex
      20ms      100ms (flat, cum)  1.83% of Total
         ...
         .       20ms    10cc02b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:19
         ...
         .       30ms    10cc067: CALL runtime.makeslice(SB)              ;main.newIndex index.go:21
         .          .    10cc06c: MOVQ 0x20(SP), AX                       ;index.go:21
         .          .    10cc071: LEAQ 0(AX)(AX*2), CX
         .          .    10cc075: MOVQ 0x18(SP), DX
         .          .    10cc07a: MOVQ 0x38(SP), BX
         .          .    10cc07f: MOVQ $0x0, 0x8(BX)(CX*8)
      20ms       20ms    10cc088: MOVQ $0x0, 0x10(BX)(CX*8)               ;main.newIndex index.go:21
         ...
         .       30ms    10cc0aa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:21
...
ROUTINE ======================== runtime.main
         ...
         .      2.51s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
