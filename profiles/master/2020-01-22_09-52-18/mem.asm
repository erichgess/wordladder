...
ROUTINE ======================== main.(*Graph).buildAdjList
  376.67MB   376.67MB (flat, cum) 45.72% of Total
   ...
   67.54MB    67.54MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
  ...
  241.12MB   241.12MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
   96.50MB    96.50MB (flat, cum) 11.71% of Total
   ...
   96.50MB    96.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.LoadDictionary
  156.95MB   822.12MB (flat, cum) 99.79% of Total
  ...
  124.06MB   124.06MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .    96.50MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   376.67MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   823.84MB (flat, cum)   100% of Total
         ...
         .   822.12MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.31% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   823.84MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
