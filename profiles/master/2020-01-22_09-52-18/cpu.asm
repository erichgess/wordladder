...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     480ms      480ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca744: MOVQ R10, 0x58(SP)                      ;main.(*Graph).buildAdjList graph.go:110
      ...
      40ms       40ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
         ...
         .      100ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca7a6: CMPQ CX, AX                             ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca7a9: JAE 0x10cab4d                           ;graph.go:112
      ...
      10ms       10ms    10ca80a: MOVQ 0x8(DI)(BX*8), R10
         ...
         .       50ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
...
ROUTINE ======================== main.(*index).add
     130ms      640ms (flat, cum) 11.79% of Total
      ...
      10ms       10ms    10cc31f: MOVQ R15, AX                            ;main.(*index).add index.go:34
         .          .    10cc322: CMPQ DI, AX                             ;index.go:34
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      40ms       40ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:40
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:40
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
      80ms       80ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
         ...
         .      500ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.(*index).near
      40ms      510ms (flat, cum)  9.39% of Total
         ...
         .       10ms    10cca93: NOPL                                    ;main.(*index).near index.go:104
      ...
      10ms       10ms    10ccba9: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:108
         .          .    10ccbb1: MOVQ 0x40(CX), DX                       ;index.go:108
         .          .    10ccbb5: TESTQ DX, DX
...
ROUTINE ======================== main.(*index).nearCount
      40ms       60ms (flat, cum)  1.10% of Total
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      640ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.79s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     100ms      100ms (flat, cum)  1.84% of Total
      ...
      20ms       20ms    10cb35b: CMPQ SI, AX                             ;main.distance graph.go:294
...
ROUTINE ======================== main.newIndex
      40ms      110ms (flat, cum)  2.03% of Total
         ...
         .       40ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:20
