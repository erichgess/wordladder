...
ROUTINE ======================== main.(*Graph).buildAdjList
  373.65MB   373.65MB (flat, cum) 45.81% of Total
   ...
   57.02MB    57.02MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   70.52MB    70.52MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  246.11MB   246.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      91MB       91MB (flat, cum) 11.16% of Total
      ...
      91MB       91MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
...
ROUTINE ======================== main.LoadDictionary
  157.85MB   814.51MB (flat, cum) 99.86% of Total
      ...
      11MB       11MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  123.96MB   123.96MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       91MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   373.65MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   815.66MB (flat, cum)   100% of Total
         ...
         .   814.51MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== runtime.main
         ...
         .   815.66MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
