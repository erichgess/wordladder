...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     230ms      230ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
     ...
     110ms      110ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca77b: MOVQ BX, 0x28(SP)                       ;main.(*Graph).buildAdjList graph.go:111
         .       80ms    10ca780: CALL main.distance(SB)
         .          .    10ca785: CMPQ $0x1, 0x30(SP)                     ;graph.go:111
      30ms       30ms    10ca78b: JNE 0x10ca95c                           ;main.(*Graph).buildAdjList graph.go:111
      ...
      30ms       30ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
      10ms       10ms    10ca80a: MOVQ 0x8(DI)(BX*8), R10
         .          .    10ca80f: LEAQ 0x1(R10), R11                      ;graph.go:113
      ...
      10ms       10ms    10ca829: JMP 0x10ca6d8                           ;main.(*Graph).buildAdjList graph.go:113
         .          .    10ca82e: MOVQ R12, 0xb8(SP)                      ;graph.go:113
         ...
         .      130ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      180ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .       80ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      590ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
     260ms      750ms (flat, cum) 12.86% of Total
         .          .    10cc260: MOVQ GS:0x30, CX                        ;index.go:42
         ...
         .          .    10cc28f: MOVQ 0xa0(SP), BX                       ;index.go:45
         ...
         .          .    10cc2c3: MOVQ 0xb0(SP), R8                       ;index.go:46
         .          .    10cc2cb: XORL AX, AX
         .          .    10cc2cd: JMP 0x10cc322
         .          .    10cc2cf: LEAQ 0x1(R8), R10                       ;index.go:52
         .          .    10cc2d3: MOVQ R10, 0x8(BX)(SI*8)
         .          .    10cc2d8: MOVQ 0xa8(SP), R10
         .          .    10cc2e0: MOVQ R10, 0(R9)(R8*8)
         .          .    10cc2e4: MOVQ 0x78(SP), R9                       ;index.go:46
         .          .    10cc2e9: MOVQ 0x50(SP), R11
         .          .    10cc2ee: MOVQ 0x58(SP), R12
         .          .    10cc2f3: MOVQ 0xb8(SP), R13
         .          .    10cc2fb: MOVQ 0xb0(SP), R14
         .          .    10cc303: MOVQ 0x68(SP), R15
         .          .    10cc308: MOVQ R12, CX                            ;index.go:136
         .          .    10cc30b: MOVQ R11, DX                            ;index.go:135
         .          .    10cc30e: MOVQ 0xa0(SP), BX                       ;index.go:49
         .          .    10cc316: MOVQ R9, SI                             ;index.go:136
         .          .    10cc319: MOVQ R13, DI                            ;index.go:46
         .          .    10cc31c: MOVQ R14, R8                            ;index.go:137
         .          .    10cc31f: MOVQ R15, AX                            ;index.go:46
         .          .    10cc322: CMPQ DI, AX
         .          .    10cc325: JGE 0x10cc533
         .       30ms    10cc32b: NOPL                                    ;main.(*index).add index.go:47
         .          .    10cc32c: CMPQ DX, AX                             ;index.go:135
         .          .    10cc32f: JA 0x10cc558
      10ms       10ms    10cc335: CMPQ CX, AX                             ;main.skipOneCopy index.go:136
         .          .    10cc338: JA 0x10cc553                            ;index.go:136
         .          .    10cc33e: MOVQ AX, 0x48(SP)                       ;index.go:46
         .          .    10cc343: SUBQ AX, CX                             ;index.go:136
         ...
         .          .    10cc395: CMPQ CX, BX
      10ms       10ms    10cc398: CMOVG CX, BX                            ;main.skipOneCopy index.go:138
         .          .    10cc39c: MOVQ 0xc0(SP), CX                       ;index.go:138
         .          .    10cc3a4: SUBQ AX, CX
         .          .    10cc3a7: NEGQ CX
         ...
         .          .    10cc3ca: MOVQ 0xa0(SP), AX                       ;index.go:49
         .          .    10cc3d2: MOVQ 0(AX), CX
         .          .    10cc3d5: MOVQ 0x8(AX), DX
         .          .    10cc3d9: MOVQ 0x20(CX), CX
         .          .    10cc3dd: MOVQ DX, 0(SP)
         .       10ms    10cc3e1: CALL CX                                 ;main.(*index).add index.go:49
         .          .    10cc3e3: MOVQ 0xa0(SP), AX                       ;index.go:50
         ...
         .          .    10cc418: CALL CX
         .          .    10cc41a: MOVQ 0xa0(SP), AX                       ;index.go:51
         .          .    10cc422: MOVQ 0(AX), CX
         .          .    10cc425: MOVQ 0x8(AX), DX
         .          .    10cc429: MOVQ 0x38(CX), CX
         .          .    10cc42d: MOVQ DX, 0(SP)
         .       20ms    10cc431: CALL CX                                 ;main.(*index).add index.go:51
         .          .    10cc433: MOVQ 0x8(SP), AX                        ;index.go:51
      20ms       20ms    10cc438: MOVQ 0xa0(SP), CX                       ;main.(*index).add index.go:51
         .          .    10cc440: MOVQ 0x40(CX), DX                       ;index.go:51
         .          .    10cc444: TESTQ DX, DX
         .          .    10cc447: JE 0x10cc54e
         .          .    10cc44d: MOVQ DX, BX
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
         .          .    10cc455: MOVQ 0x10(CX), BX                       ;index.go:52
         .          .    10cc459: MOVQ 0x18(CX), SI
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
     200ms      200ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:52
         .          .    10cc474: MOVQ 0(BX)(SI*8), R9                    ;index.go:52
         ...
         .      430ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:52
         .          .    10cc4c2: MOVQ 0x28(SP), AX                       ;index.go:52
      10ms       10ms    10cc4c7: MOVQ 0x30(SP), CX                       ;main.(*index).add index.go:52
         .          .    10cc4cc: MOVQ 0x38(SP), DX                       ;index.go:52
         ...
         .          .    10cc4f0: MOVQ CX, R8
         .          .    10cc4f3: MOVQ AX, R9
         .          .    10cc4f6: MOVQ 0xa0(SP), CX                       ;index.go:49
         .          .    10cc4fe: MOVQ BX, DX                             ;index.go:52
         .          .    10cc501: MOVQ SI, BX
         .          .    10cc504: MOVQ DX, SI
         ...
         .          .    10cc51b: MOVQ R8, 0(SP)                          ;index.go:138
      10ms       10ms    10cc51f: MOVQ CX, 0x8(SP)                        ;main.skipOneCopy index.go:138
         .          .    10cc524: MOVQ BX, 0x10(SP)                       ;index.go:138
         .          .    10cc529: CALL runtime.memmove(SB)
         .          .    10cc52e: JMP 0x10cc3ca
         .          .    10cc533: MOVQ 0x90(SP), BP
         .          .    10cc53b: ADDQ $0x98, SP
         .          .    10cc542: RET
         .          .    10cc543: MOVQ DX, AX                             ;index.go:52
         .          .    10cc546: MOVQ SI, CX
         .          .    10cc549: CALL runtime.panicIndexU(SB)
         .          .    10cc54e: CALL runtime.panicdivide(SB)            ;index.go:51
         .          .    10cc553: CALL runtime.panicSliceB(SB)            ;index.go:136
         .          .    10cc558: MOVQ AX, CX                             ;index.go:135
         .          .    10cc55b: CALL runtime.panicSliceAcap(SB)
         .          .    10cc560: CALL runtime.panicSliceAcap(SB)         ;index.go:45
         .          .    10cc565: NOPL
         .          .    10cc566: CALL runtime.morestack_noctxt(SB)       ;index.go:42
         .          .    10cc56b: ?
         .          .    10cc56c: LOCK CLD
         .          .    10cc56e: ?
ROUTINE ======================== main.(*index).near
      40ms      590ms (flat, cum) 10.12% of Total
         .          .    10cc900: MOVQ GS:0x30, CX                        ;index.go:108
         ...
         .          .    10cc9bf: CALL CX
         .          .    10cc9c1: MOVQ 0x218(SP), AX                      ;index.go:113
         ...
         .          .    10cc9f7: XORL DX, DX
         .          .    10cc9f9: DIVQ BX
      10ms       10ms    10cc9fc: MOVQ 0x60(SP), BX                       ;main.(*index).near index.go:113
         .          .    10cca01: TESTQ BX, BX                            ;index.go:113
         .          .    10cca04: JBE 0x10ccd20
         .          .    10cca0a: MOVQ DX, 0x78(SP)
         .          .    10cca0f: MOVQ 0x28(CX), SI                       ;index.go:114
         ...
         .          .    10cca3e: MOVQ 0x220(SP), R9                      ;index.go:115
         .          .    10cca46: XORL AX, AX
         .          .    10cca48: JMP 0x10cca8a
         .          .    10cca4a: MOVQ AX, R10                            ;index.go:120
         .          .    10cca4d: SHLQ $0x3, AX
         .          .    10cca51: MOVQ DX, 0x78(SP)(AX*1)
         .          .    10cca56: MOVQ 0x228(SP), R11                     ;index.go:115
         .          .    10cca5e: MOVQ 0x200(SP), R12
         .          .    10cca66: MOVQ 0x48(SP), R13
         .          .    10cca6b: MOVQ 0x68(SP), R14
         .          .    10cca70: MOVQ 0x220(SP), R15
         .          .    10cca78: MOVQ R13, DX                            ;index.go:135
         .          .    10cca7b: MOVQ R12, SI                            ;index.go:136
         .          .    10cca7e: MOVQ R11, DI                            ;index.go:115
         .          .    10cca81: MOVQ R14, R8                            ;index.go:136
         .          .    10cca84: MOVQ R15, R9                            ;index.go:137
         .          .    10cca87: MOVQ R10, AX                            ;index.go:115
         .          .    10cca8a: CMPQ DI, AX
         .          .    10cca8d: JGE 0x10ccbf6
         .          .    10cca93: NOPL                                    ;index.go:116
         .          .    10cca94: CMPQ DX, AX                             ;index.go:135
         .          .    10cca97: JA 0x10ccd10
         .          .    10cca9d: CMPQ R8, AX                             ;index.go:136
         .          .    10ccaa0: JA 0x10ccd08
         .          .    10ccaa6: MOVQ AX, 0x40(SP)                       ;index.go:115
         .          .    10ccaab: SUBQ AX, R8                             ;index.go:136
         ...
         .          .    10ccb38: MOVQ 0x218(SP), AX                      ;index.go:118
         .          .    10ccb40: MOVQ 0(AX), CX
         .          .    10ccb43: MOVQ 0x8(AX), DX
         .          .    10ccb47: MOVQ 0x20(CX), CX
         .          .    10ccb4b: MOVQ DX, 0(SP)
         .       20ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:118
         .          .    10ccb51: MOVQ 0x218(SP), AX                      ;index.go:119
         ...
         .       10ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:119
         .          .    10ccb8b: MOVQ 0x218(SP), AX                      ;index.go:120
         .          .    10ccb93: MOVQ 0(AX), CX
         .          .    10ccb96: MOVQ 0x8(AX), DX
         .          .    10ccb9a: MOVQ 0x38(CX), CX
         .          .    10ccb9e: MOVQ DX, 0(SP)
         .       40ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:120
         .          .    10ccba4: MOVQ 0x8(SP), AX                        ;index.go:120
      10ms       10ms    10ccba9: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:120
         .          .    10ccbb1: MOVQ 0x40(CX), DX                       ;index.go:120
         .          .    10ccbb5: TESTQ DX, DX
         .          .    10ccbb8: JE 0x10ccd03
         .          .    10ccbbe: MOVQ DX, BX
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      20ms       20ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:120
         .          .    10ccbcb: MOVQ 0x60(SP), BX                       ;index.go:120
         .          .    10ccbd0: CMPQ BX, AX
         .          .    10ccbd3: JB 0x10cca4a
         .          .    10ccbd9: JMP 0x10cccfb
         .          .    10ccbde: MOVQ R8, 0(SP)                          ;index.go:138
         .          .    10ccbe2: MOVQ CX, 0x8(SP)
         .          .    10ccbe7: MOVQ BX, 0x10(SP)
         .          .    10ccbec: CALL runtime.memmove(SB)
         .          .    10ccbf1: JMP 0x10ccb38
         .          .    10ccbf6: MOVQ 0x248(SP), DX                      ;index.go:124
         ...
         .          .    10ccc15: INCQ AX
         .          .    10ccc18: MOVQ R11, DX                            ;index.go:128
         .          .    10ccc1b: MOVQ SI, R8
         .          .    10ccc1e: MOVQ R10, SI
         .          .    10ccc21: CMPQ BX, AX                             ;index.go:124
         .          .    10ccc24: JGE 0x10cccd5
         .          .    10ccc2a: MOVQ 0x78(SP)(AX*8), R9                 ;index.go:125
         .          .    10ccc2f: MOVQ 0x10(CX), R10                      ;index.go:126
         ...
         .          .    10ccc4d: CMPQ SI, R8                             ;index.go:128
         .          .    10ccc50: JA 0x10ccce5
         .          .    10ccc56: MOVQ SI, R10
         .          .    10ccc59: SUBQ R8, SI
         .          .    10ccc5c: CMPQ R11, SI
         ...
         .          .    10ccc80: MOVQ AX, 0x58(SP)                       ;index.go:124
         .          .    10ccc85: MOVQ SI, 0x50(SP)                       ;index.go:128
         .          .    10ccc8a: MOVQ DX, 0(SP)
         .          .    10ccc8e: MOVQ R9, 0x8(SP)
         .          .    10ccc93: SHLQ $0x3, SI
         .          .    10ccc97: MOVQ SI, 0x10(SP)
         .      480ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:128
         .          .    10ccca1: MOVQ 0x58(SP), AX                       ;index.go:124
         .          .    10ccca6: MOVQ 0x218(SP), CX                      ;index.go:126
         .          .    10cccae: MOVQ 0x60(SP), BX                       ;index.go:124
         .          .    10cccb3: MOVQ 0x50(SP), SI                       ;index.go:128
...
ROUTINE ======================== main.(*index).nearCount
     140ms      300ms (flat, cum)  5.15% of Total
         .          .    10cc570: MOVQ GS:0x30, CX                        ;index.go:70
         ...
         .          .    10cc5a2: LEAQ 0x68(SP), DI                       ;index.go:71
      10ms       10ms    10cc5a7: XORPS X0, X0                            ;main.(*index).nearCount index.go:71
         .          .    10cc5aa: MOVQ BP, -0x10(SP)                      ;index.go:71
         .          .    10cc5af: LEAQ -0x10(SP), BP
         .          .    10cc5b4: CALL 0x105866e
         .          .    10cc5b9: MOVQ 0(BP), BP
         .          .    10cc5bd: MOVQ 0x218(SP), AX                      ;index.go:72
         .          .    10cc5c5: LEAQ 0x1(AX), CX
         .          .    10cc5c9: CMPQ $0x30, CX
         .          .    10cc5cd: JA 0x10cc8e8
         .          .    10cc5d3: MOVQ CX, 0x50(SP)
         .          .    10cc5d8: MOVQ 0x208(SP), AX                      ;index.go:73
         .          .    10cc5e0: MOVQ 0(AX), CX
         .          .    10cc5e3: MOVQ 0x8(AX), DX
         .          .    10cc5e7: MOVQ 0x20(CX), CX
         .          .    10cc5eb: MOVQ DX, 0(SP)
         .          .    10cc5ef: CALL CX
         .          .    10cc5f1: MOVQ 0x208(SP), AX                      ;index.go:74
         ...
         .          .    10cc62f: CALL CX
         .          .    10cc631: MOVQ 0x208(SP), AX                      ;index.go:75
         .          .    10cc639: MOVQ 0(AX), CX
         .          .    10cc63c: MOVQ 0x8(AX), DX
         .          .    10cc640: MOVQ 0x38(CX), CX
         .          .    10cc644: MOVQ DX, 0(SP)
         .       10ms    10cc648: CALL CX                                 ;main.(*index).nearCount index.go:75
         .          .    10cc64a: MOVQ 0x8(SP), AX                        ;index.go:75
         ...
         .          .    10cc67f: MOVQ 0x38(CX), DX                       ;index.go:76
         ...
         .          .    10cc6ae: MOVQ 0x210(SP), R9                      ;index.go:77
         .          .    10cc6b6: XORL AX, AX
         .          .    10cc6b8: JMP 0x10cc6fa
         .          .    10cc6ba: MOVQ AX, R10                            ;index.go:82
         .          .    10cc6bd: SHLQ $0x3, AX
         .          .    10cc6c1: MOVQ DX, 0x68(SP)(AX*1)
         .          .    10cc6c6: MOVQ 0x218(SP), R11                     ;index.go:77
         .          .    10cc6ce: MOVQ 0x1f0(SP), R12
         .          .    10cc6d6: MOVQ 0x48(SP), R13
         .          .    10cc6db: MOVQ 0x58(SP), R14
         .          .    10cc6e0: MOVQ 0x210(SP), R15
         .          .    10cc6e8: MOVQ R13, DX                            ;index.go:135
         .          .    10cc6eb: MOVQ R12, SI                            ;index.go:136
         .          .    10cc6ee: MOVQ R11, DI                            ;index.go:77
         .          .    10cc6f1: MOVQ R14, R8                            ;index.go:136
         .          .    10cc6f4: MOVQ R15, R9                            ;index.go:137
         .          .    10cc6f7: MOVQ R10, AX                            ;index.go:77
         .          .    10cc6fa: CMPQ DI, AX
         .          .    10cc6fd: JGE 0x10cc863
         .       40ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:78
         .          .    10cc704: CMPQ DX, AX                             ;index.go:135
         .          .    10cc707: JA 0x10cc8c9
         .          .    10cc70d: CMPQ R8, AX                             ;index.go:136
         .          .    10cc710: JA 0x10cc8c1
         .          .    10cc716: MOVQ AX, 0x40(SP)                       ;index.go:77
         .          .    10cc71b: SUBQ AX, R8                             ;index.go:136
      10ms       10ms    10cc71e: MOVQ R8, 0x38(SP)                       ;main.skipOneCopy index.go:136
         .          .    10cc723: SUBQ AX, DX                             ;index.go:136
         .          .    10cc726: NEGQ DX
         .          .    10cc729: SARQ $0x3f, DX
         .          .    10cc72d: ANDQ AX, DX
         .          .    10cc730: ADDQ SI, DX
         .          .    10cc733: MOVQ DX, 0x1e8(SP)
         .          .    10cc73b: CMPQ R9, SI                             ;index.go:137
         .          .    10cc73e: JE 0x10cc753
         .          .    10cc740: MOVQ SI, 0(SP)
         .          .    10cc744: MOVQ R9, 0x8(SP)
         .          .    10cc749: MOVQ AX, 0x10(SP)
      10ms       10ms    10cc74e: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:137
         .          .    10cc753: MOVQ 0x40(SP), AX                       ;index.go:138
         .          .    10cc758: INCQ AX
         ...
         .          .    10cc770: CMPQ CX, BX
      10ms       10ms    10cc773: CMOVG CX, BX                            ;main.skipOneCopy index.go:138
         .          .    10cc777: MOVQ 0x220(SP), CX                      ;index.go:138
         .          .    10cc77f: SUBQ AX, CX
         .          .    10cc782: NEGQ CX
         ...
         .          .    10cc7a8: MOVQ 0x208(SP), AX                      ;index.go:80
         .          .    10cc7b0: MOVQ 0(AX), CX
         .          .    10cc7b3: MOVQ 0x8(AX), DX
         .          .    10cc7b7: MOVQ 0x20(CX), CX
         .          .    10cc7bb: MOVQ DX, 0(SP)
         .       20ms    10cc7bf: CALL CX                                 ;main.(*index).nearCount index.go:80
      10ms       10ms    10cc7c1: MOVQ 0x208(SP), AX                      ;main.(*index).nearCount index.go:81
         .          .    10cc7c9: MOVQ 0(AX), CX                          ;index.go:81
         ...
         .       20ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:81
         .          .    10cc7fb: MOVQ 0x208(SP), AX                      ;index.go:82
         .          .    10cc803: MOVQ 0(AX), CX
         .          .    10cc806: MOVQ 0x8(AX), DX
         .          .    10cc80a: MOVQ 0x38(CX), CX
         .          .    10cc80e: MOVQ DX, 0(SP)
         .       60ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:82
         .          .    10cc814: MOVQ 0x8(SP), AX                        ;index.go:82
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      60ms       60ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:82
         .          .    10cc83b: MOVQ 0x50(SP), BX                       ;index.go:82
         .          .    10cc840: CMPQ BX, AX
         .          .    10cc843: JB 0x10cc6ba
         .          .    10cc849: JMP 0x10cc8b4
         .          .    10cc84b: MOVQ R8, 0(SP)                          ;index.go:138
         .          .    10cc84f: MOVQ CX, 0x8(SP)
         .          .    10cc854: MOVQ BX, 0x10(SP)
         .       10ms    10cc859: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:138
         .          .    10cc85e: JMP 0x10cc7a8                           ;index.go:138
         .          .    10cc863: XORL AX, AX
         .          .    10cc865: XORL DX, DX
         .          .    10cc867: JMP 0x10cc878                           ;index.go:86
         .          .    10cc869: INCQ AX
         .          .    10cc86c: LEAQ 0(R8)(R8*2), SI                    ;index.go:87
         .          .    10cc870: MOVQ 0x8(DI)(SI*8), SI
      30ms       30ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:88
         .          .    10cc878: CMPQ BX, AX                             ;index.go:86
         .          .    10cc87b: JGE 0x10cc891
         .          .    10cc87d: MOVQ 0x18(CX), SI                       ;index.go:87
         .          .    10cc881: MOVQ 0x10(CX), DI
         .          .    10cc885: MOVQ 0x68(SP)(AX*8), R8
         .          .    10cc88a: CMPQ SI, R8
         .          .    10cc88d: JB 0x10cc869
         .          .    10cc88f: JMP 0x10cc8a9
         .          .    10cc891: MOVQ DX, 0x228(SP)                      ;index.go:91
         .          .    10cc899: MOVQ 0x1f8(SP), BP
         .          .    10cc8a1: ADDQ $0x200, SP
         .          .    10cc8a8: RET
         .          .    10cc8a9: MOVQ R8, AX                             ;index.go:87
         .          .    10cc8ac: MOVQ SI, CX
         .          .    10cc8af: CALL runtime.panicIndexU(SB)
         .          .    10cc8b4: MOVQ BX, CX                             ;index.go:82
         .          .    10cc8b7: CALL runtime.panicIndex(SB)
         .          .    10cc8bc: CALL runtime.panicdivide(SB)
         .          .    10cc8c1: MOVQ R8, CX                             ;index.go:136
         .          .    10cc8c4: CALL runtime.panicSliceB(SB)
         .          .    10cc8c9: MOVQ AX, CX                             ;index.go:135
         .          .    10cc8cc: CALL runtime.panicSliceAcap(SB)
         .          .    10cc8d1: MOVQ R8, CX                             ;index.go:76
         .          .    10cc8d4: CALL runtime.panicSliceAcap(SB)
         .          .    10cc8d9: XORL AX, AX                             ;index.go:75
         .          .    10cc8db: MOVQ BX, CX
         .          .    10cc8de: CALL runtime.panicIndex(SB)
         .          .    10cc8e3: CALL runtime.panicdivide(SB)
         .          .    10cc8e8: MOVL $0x30, DX                          ;index.go:72
         .          .    10cc8ed: CALL runtime.panicSliceAlen(SB)
         .          .    10cc8f2: NOPL
         .          .    10cc8f3: CALL runtime.morestack_noctxt(SB)       ;index.go:70
...
ROUTINE ======================== main.LoadDictionary
      30ms      2.75s (flat, cum) 47.17% of Total
         ...
         .       40ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
      ...
      30ms       30ms    10ca17b: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:59
         .          .    10ca180: MOVQ BX, 0x10(R8)(DX*8)                 ;graph.go:59
         ...
         .       70ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
         ...
         .      120ms    10ca358: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
         ...
         .      720ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.76s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      ...
      60ms       60ms    10cb348: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
         .          .    10cb34c: CMPL R10, R9                            ;graph.go:294
         .          .    10cb34f: CMOVNE R11, BX                          ;graph.go:295
      20ms       20ms    10cb353: INCQ AX                                 ;main.distance graph.go:293
...
ROUTINE ======================== main.main
         ...
         .      2.75s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     100ms      120ms (flat, cum)  2.06% of Total
         .          .    10cc040: MOVQ GS:0x30, CX                        ;index.go:29
         .          .    10cc049: CMPQ 0x10(CX), SP
         .          .    10cc04d: JBE 0x10cc24e
         .          .    10cc053: SUBQ $0x48, SP
         .          .    10cc057: MOVQ BP, 0x40(SP)
         .          .    10cc05c: LEAQ 0x40(SP), BP
         .          .    10cc061: LEAQ runtime.types+77472(SB), AX        ;index.go:30
         .          .    10cc068: MOVQ AX, 0(SP)
         .          .    10cc06c: MOVQ 0x50(SP), AX
         .          .    10cc071: MOVQ AX, 0x8(SP)
         .          .    10cc076: MOVQ AX, 0x10(SP)
         .       20ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:30
         .          .    10cc080: MOVQ 0x18(SP), AX                       ;index.go:30
         .          .    10cc085: MOVQ AX, 0x38(SP)
         .          .    10cc08a: XORL CX, CX
         .          .    10cc08c: JMP 0x10cc095                           ;index.go:31
         .          .    10cc08e: LEAQ 0x1(AX), CX
         .          .    10cc092: MOVQ BX, AX                             ;index.go:32
         .          .    10cc095: MOVQ 0x50(SP), DX                       ;index.go:31
         .          .    10cc09a: CMPQ DX, CX
         .          .    10cc09d: JGE 0x10cc104
         .          .    10cc09f: MOVQ CX, 0x20(SP)
         .          .    10cc0a4: LEAQ runtime.types+86176(SB), AX        ;index.go:32
      ...
      70ms       70ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:32
      30ms       30ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
         .          .    10cc0e1: LEAQ 0(BX)(CX*8), DI                    ;index.go:32
         .          .    10cc0e5: CMPL $0x0, runtime.writeBarrier(SB)
         .          .    10cc0ec: JNE 0x10cc0f4
         .          .    10cc0ee: MOVQ DX, 0(BX)(CX*8)
         .          .    10cc0f2: JMP 0x10cc08e
         .          .    10cc0f4: MOVQ AX, CX                             ;index.go:31
         .          .    10cc0f7: MOVQ DX, AX                             ;index.go:32
         .          .    10cc0fa: CALL runtime.gcWriteBarrier(SB)
         .          .    10cc0ff: MOVQ CX, AX                             ;index.go:31
         .          .    10cc102: JMP 0x10cc08e                           ;index.go:32
         ...
         .          .    10cc130: LEAQ runtime.types+89184(SB), AX        ;index.go:36
         ...
         .          .    10cc15d: LEAQ runtime.types+196608(SB), CX       ;index.go:38
         ...
         .          .    10cc192: MOVQ $0x0, 0x30(AX)                     ;index.go:36
         ...
         .          .    10cc1b5: MOVQ 0x50(SP), CX                       ;index.go:37
         ...
         .          .    10cc1d4: MOVQ CX, 0x40(AX)                       ;index.go:38
         .          .    10cc1d8: MOVQ AX, 0x60(SP)                       ;index.go:34
         .          .    10cc1dd: MOVQ 0x40(SP), BP
         .          .    10cc1e2: ADDQ $0x48, SP
         .          .    10cc1e6: RET
         .          .    10cc1e7: LEAQ 0x10(AX), DI                       ;index.go:37
         .          .    10cc1eb: MOVQ AX, DX                             ;index.go:38
         .          .    10cc1ee: MOVQ 0x38(SP), AX                       ;index.go:37
         .          .    10cc1f3: CALL runtime.gcWriteBarrier(SB)
         .          .    10cc1f8: MOVQ DX, AX                             ;index.go:38
         .          .    10cc1fb: JMP 0x10cc1d4                           ;index.go:37
         .          .    10cc1fd: LEAQ 0x28(AX), DI                       ;index.go:36
         .          .    10cc201: MOVQ AX, CX                             ;index.go:38
         .          .    10cc204: MOVQ 0x30(SP), AX                       ;index.go:36
         .          .    10cc209: CALL runtime.gcWriteBarrier(SB)
         .          .    10cc20e: MOVQ CX, AX                             ;index.go:37
         .          .    10cc211: JMP 0x10cc1b5                           ;index.go:36
         .          .    10cc213: LEAQ 0x8(AX), DI                        ;index.go:35
         .          .    10cc217: MOVQ AX, CX                             ;index.go:38
         .          .    10cc21a: MOVQ 0x28(SP), AX                       ;index.go:35
         .          .    10cc21f: CALL runtime.gcWriteBarrier(SB)
         .          .    10cc224: MOVQ CX, AX                             ;index.go:36
         .          .    10cc227: JMP 0x10cc192                           ;index.go:35
         ...
         .          .    10cc24d: NOPL
         .          .    10cc24e: CALL runtime.morestack_noctxt(SB)       ;index.go:29
...
ROUTINE ======================== runtime.main
         ...
         .      2.76s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
