...
ROUTINE ======================== main.(*Graph).buildAdjList
  358.15MB   358.15MB (flat, cum) 44.99% of Total
   ...
   59.53MB    59.53MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   63.01MB    63.01MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
...
ROUTINE ======================== main.(*index).add
   83.50MB    83.50MB (flat, cum) 10.49% of Total
   ...
   83.50MB    83.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.LoadDictionary
  160.24MB   793.90MB (flat, cum) 99.73% of Total
   ...
   11.50MB    11.50MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  125.85MB   125.85MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .    83.50MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   358.15MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   795.06MB (flat, cum) 99.87% of Total
         ...
         .   793.90MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.12% of Total
     ...
     192MB      192MB    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:23
...
ROUTINE ======================== runtime.main
         0   795.56MB (flat, cum) 99.94% of Total
         ...
         .   512.31kB    102ccc5: CALL runtime.doInit(SB)                 ;runtime.main proc.go:190
         ...
         .   795.06MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
