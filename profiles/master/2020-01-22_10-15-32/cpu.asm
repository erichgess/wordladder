...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     420ms      420ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca7df: MOVQ 0x58(SP), BX                       ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca7e4: MOVQ BX, 0(R9)(R8*8)                    ;graph.go:112
      ...
      10ms       10ms    10ca829: JMP 0x10ca6d8                           ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      200ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
      ...
      10ms       10ms    10ca95c: MOVQ 0x60(SP), AX                       ;main.(*Graph).buildAdjList graph.go:104
         ...
         .      180ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      ...
      30ms       30ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:45
         ...
         .      610ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:45
...
ROUTINE ======================== main.(*index).near
      90ms      510ms (flat, cum)  9.38% of Total
         ...
         .          .    10cc9f7: XORL DX, DX
         .          .    10cc9f9: DIVQ BX
      10ms       10ms    10cc9fc: MOVQ 0x60(SP), BX                       ;main.(*index).near index.go:106
         .          .    10cca01: TESTQ BX, BX                            ;index.go:106
      ...
      10ms       10ms    10cca78: MOVQ R13, DX                            ;main.skipOneCopy index.go:128
         ...
         .       10ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:111
         ...
         .       10ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:113
         .          .    10ccba4: MOVQ 0x8(SP), AX                        ;index.go:113
      10ms       10ms    10ccba9: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:113
         .          .    10ccbb1: MOVQ 0x40(CX), DX                       ;index.go:113
         .          .    10ccbb5: TESTQ DX, DX
         .          .    10ccbb8: JE 0x10ccd03
         .          .    10ccbbe: MOVQ DX, BX
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      30ms       30ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:113
         ...
         .          .    10ccc1b: MOVQ SI, R8
      10ms       10ms    10ccc1e: MOVQ R10, SI                            ;main.(*index).near index.go:121
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:121
         ...
         .          .    10ccc74: ANDQ DX, R8
      10ms       10ms    10ccc77: LEAQ 0(DI)(R8*1), DX                    ;main.(*index).near index.go:121
         .          .    10ccc7b: CMPQ R9, DX                             ;index.go:121
         ...
         .      370ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:121
...
ROUTINE ======================== main.(*index).nearCount
     120ms      160ms (flat, cum)  2.94% of Total
      ...
      10ms       10ms    10cc592: MOVQ BP, 0x1f8(SP)                      ;main.(*index).nearCount index.go:63
         .          .    10cc59a: LEAQ 0x1f8(SP), BP                      ;index.go:63
      ...
      10ms       10ms    10cc704: CMPQ DX, AX                             ;main.skipOneCopy index.go:128
         .          .    10cc707: JA 0x10cc8c9                            ;index.go:128
         ...
         .          .    10cc82e: MOVQ DX, BX
      10ms       10ms    10cc831: XORL DX, DX                             ;main.(*index).nearCount index.go:75
         .          .    10cc833: DIVQ BX                                 ;index.go:75
      ...
      80ms       80ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:81
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca2a0: MOVQ AX, 0x58(SP)                       ;main.LoadDictionary graph.go:70
         ...
         .      660ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
...
ROUTINE ======================== main.distance
     110ms      110ms (flat, cum)  2.02% of Total
      ...
      20ms       20ms    10cb318: CMPQ DX, CX                             ;main.distance graph.go:290
      ...
      50ms       50ms    10cb348: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
      10ms       10ms    10cb34c: CMPL R10, R9                            ;main.distance graph.go:294
...
ROUTINE ======================== main.main
         ...
         .      2.70s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc092: MOVQ BX, AX                             ;main.newIndex index.go:25
         ...
         .       10ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:25
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:25
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      10ms       10ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:25
         .          .    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)               ;index.go:25
      10ms       10ms    10cc0e1: LEAQ 0(BX)(CX*8), DI                    ;main.newIndex index.go:25
         .          .    10cc0e5: CMPL $0x0, runtime.writeBarrier(SB)     ;index.go:25
      10ms       10ms    10cc0ec: JNE 0x10cc0f4                           ;main.newIndex index.go:25
      10ms       10ms    10cc0ee: MOVQ DX, 0(BX)(CX*8)
         .          .    10cc0f2: JMP 0x10cc08e                           ;index.go:25
         .          .    10cc0f4: MOVQ AX, CX                             ;index.go:24
         .          .    10cc0f7: MOVQ DX, AX                             ;index.go:25
         .       10ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:25
