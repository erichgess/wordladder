...
ROUTINE ======================== main.(*Graph).buildAdjList
  362.63MB   362.63MB (flat, cum) 45.48% of Total
   ...
   58.51MB    58.51MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   69.51MB    69.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  234.61MB   234.61MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      86MB       86MB (flat, cum) 10.79% of Total
      ...
      86MB       86MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.LoadDictionary
  156.17MB   796.81MB (flat, cum) 99.93% of Total
  ...
  125.28MB   125.28MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .       86MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   362.63MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   797.37MB (flat, cum)   100% of Total
         ...
         .   796.81MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.08% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   797.37MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
