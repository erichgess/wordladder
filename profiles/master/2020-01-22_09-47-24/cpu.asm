...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     350ms      350ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      30ms       30ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca799: MOVQ 0x18(DX), BX                       ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca79d: MOVQ 0x20(DX), CX                       ;graph.go:112
      ...
      10ms       10ms    10ca836: MOVQ DI, 0xb0(SP)                       ;main.(*Graph).buildAdjList graph.go:113
         .          .    10ca83e: LEAQ runtime.types+86176(SB), AX        ;graph.go:113
         .          .    10ca845: MOVQ AX, 0(SP)
         .          .    10ca849: MOVQ R8, 0x8(SP)
         .          .    10ca84e: MOVQ R10, 0x10(SP)
         .          .    10ca853: MOVQ R9, 0x18(SP)
         .          .    10ca858: MOVQ R11, 0x20(SP)
         .      250ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .       40ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      630ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      60ms      480ms (flat, cum)  8.73% of Total
      ...
      10ms       10ms    10cc2e4: MOVQ 0x78(SP), R9                       ;main.(*index).add index.go:34
         .          .    10cc2e9: MOVQ 0x50(SP), R11                      ;index.go:34
         ...
         .       20ms    10cc32b: NOPL                                    ;main.(*index).add index.go:35
         ...
         .       10ms    10cc373: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:125
         ...
         .       10ms    10cc418: CALL CX                                 ;main.(*index).add index.go:38
      10ms       10ms    10cc41a: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:39
         .          .    10cc422: MOVQ 0(AX), CX                          ;index.go:39
         .          .    10cc425: MOVQ 0x8(AX), DX
         .          .    10cc429: MOVQ 0x38(CX), CX
         .          .    10cc42d: MOVQ DX, 0(SP)
         .       20ms    10cc431: CALL CX                                 ;main.(*index).add index.go:39
      ...
      30ms       30ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
         ...
         .      350ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.(*index).near
      30ms      630ms (flat, cum) 11.45% of Total
         ...
         .       10ms    10cc944: CALL 0x105866e                          ;main.(*index).near index.go:97
         .          .    10cc949: MOVQ 0(BP), BP                          ;index.go:97
         ...
         .          .    10cc97f: CALL CX
      10ms       10ms    10cc981: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:100
         .          .    10cc989: MOVQ 0(AX), CX                          ;index.go:100
         ...
         .       10ms    10cc9bf: CALL CX                                 ;main.(*index).near index.go:100
      ...
      10ms       10ms    10cca0f: MOVQ 0x28(CX), SI                       ;main.(*index).near index.go:102
         .          .    10cca13: MOVQ 0x38(CX), DX                       ;index.go:102
         ...
         .       10ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:107
         ...
         .       10ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:108
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      10ms       10ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:108
         ...
         .      550ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
...
ROUTINE ======================== main.(*index).nearCount
      90ms      150ms (flat, cum)  2.73% of Total
         ...
         .       10ms    10cc5ef: CALL CX                                 ;main.(*index).nearCount index.go:61
         ...
         .          .    10cc667: XORL DX, DX
         .          .    10cc669: DIVQ BX
      10ms       10ms    10cc66c: MOVQ 0x50(SP), BX                       ;main.(*index).nearCount index.go:63
         .          .    10cc671: TESTQ BX, BX                            ;index.go:63
         ...
         .          .    10cc6ba: MOVQ AX, R10                            ;index.go:70
         .          .    10cc6bd: SHLQ $0x3, AX
         ...
         .       10ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:66
         ...
         .          .    10cc7a8: MOVQ 0x208(SP), AX                      ;index.go:68
         ...
         .       10ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:70
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      30ms       30ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:70
         ...
         .       10ms    10cc859: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:126
         .          .    10cc85e: JMP 0x10cc7a8                           ;index.go:126
         .          .    10cc863: XORL AX, AX
         .          .    10cc865: XORL DX, DX
      ...
      50ms       50ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:76
...
ROUTINE ======================== main.LoadDictionary
      ...
      20ms       20ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      100ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
      ...
      20ms       20ms    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)               ;main.LoadDictionary graph.go:71
         ...
         .       80ms    10ca358: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
         ...
         .      460ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.75s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb335: MOVQ 0x38(SP), DX                       ;main.distance graph.go:286
         .          .    10cb33a: MOVQ 0x20(SP), R8                       ;graph.go:286
         .          .    10cb33f: XORL AX, AX
...
ROUTINE ======================== main.main
         ...
         .      2.45s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc092: MOVQ BX, AX                             ;main.newIndex index.go:20
         ...
         .       20ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:20
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:20
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      10ms       10ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:20
      ...
      10ms       10ms    10cc0ee: MOVQ DX, 0(BX)(CX*8)                    ;main.newIndex index.go:20
         .          .    10cc0f2: JMP 0x10cc08e                           ;index.go:20
...
ROUTINE ======================== runtime.main
         ...
         .      2.45s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
