...
ROUTINE ======================== main.(*Graph).buildAdjList
  369.13MB   369.13MB (flat, cum) 45.05% of Total
   ...
   63.51MB    63.51MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   80.52MB    80.52MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  225.10MB   225.10MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
  102.50MB   102.50MB (flat, cum) 12.51% of Total
...
ROUTINE ======================== main.LoadDictionary
  153.94MB   817.58MB (flat, cum) 99.79% of Total
       ...
       6MB        6MB    10ca117: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:57
  ...
  125.05MB   125.05MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   369.13MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   819.30MB (flat, cum)   100% of Total
         ...
         .   817.58MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.43% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   819.30MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
