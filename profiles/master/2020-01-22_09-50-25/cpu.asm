...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     540ms      540ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      70ms       70ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
         ...
         .      130ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca829: JMP 0x10ca6d8                           ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      130ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      220ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      100ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
         0      440ms (flat, cum)  8.01% of Total
         ...
         .      420ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.(*index).near
      ...
      10ms       10ms    10ccaf0: MOVQ 0x228(SP), CX                      ;main.skipOneCopy index.go:126
         .          .    10ccaf8: SUBQ AX, CX                             ;index.go:126
         ...
         .       20ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:106
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:116
         ...
         .      410ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
...
ROUTINE ======================== main.(*index).nearCount
     130ms      230ms (flat, cum)  4.19% of Total
         ...
         .       50ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:69
      ...
      10ms       10ms    10cc819: MOVQ 0x208(SP), CX                      ;main.(*index).nearCount index.go:70
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      50ms       50ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:70
      ...
      70ms       70ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:76
...
ROUTINE ======================== main.LoadDictionary
      ...
      10ms       10ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .       90ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
         ...
         .      430ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.87s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     130ms      130ms (flat, cum)  2.37% of Total
         ...
         .          .    10cb32b: SUBQ SI, DX
      10ms       10ms    10cb32e: TESTQ BX, BX                            ;main.distance graph.go:286
...
ROUTINE ======================== main.main
         ...
         .      2.52s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc040: MOVQ GS:0x30, CX                        ;main.newIndex index.go:17
         .          .    10cc049: CMPQ 0x10(CX), SP                       ;index.go:17
         ...
         .       30ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:18
