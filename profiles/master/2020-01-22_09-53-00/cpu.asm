...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     460ms      460ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      10ms       10ms    10ca72c: MOVQ 0x8(BX), R11                       ;main.(*Graph).buildAdjList graph.go:111
      ...
      70ms       70ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      10ms       10ms    10ca75e: MOVQ 0x8(R12)(AX*8), R8
         ...
         .      110ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      110ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      190ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      140ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      470ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
     200ms      1.04s (flat, cum) 18.51% of Total
         ...
         .       30ms    10cc32b: NOPL                                    ;main.(*index).add index.go:35
         ...
         .          .    10cc395: CMPQ CX, BX
      10ms       10ms    10cc398: CMOVG CX, BX                            ;main.skipOneCopy index.go:126
      10ms       10ms    10cc39c: MOVQ 0xc0(SP), CX
         .          .    10cc3a4: SUBQ AX, CX                             ;index.go:126
         .          .    10cc3a7: NEGQ CX
      ...
      10ms       10ms    10cc3d5: MOVQ 0x8(AX), DX                        ;main.(*index).add index.go:37
         .          .    10cc3d9: MOVQ 0x20(CX), CX                       ;index.go:37
      ...
      10ms       10ms    10cc3ff: MOVQ DX, 0x8(SP)                        ;main.(*index).add index.go:38
         .          .    10cc404: MOVQ 0x58(SP), BX                       ;index.go:38
         .          .    10cc409: MOVQ BX, 0x10(SP)
         .          .    10cc40e: MOVQ 0x50(SP), SI
         .          .    10cc413: MOVQ SI, 0x18(SP)
         .       40ms    10cc418: CALL CX                                 ;main.(*index).add index.go:38
         .          .    10cc41a: MOVQ 0xa0(SP), AX                       ;index.go:39
         .          .    10cc422: MOVQ 0(AX), CX
         .          .    10cc425: MOVQ 0x8(AX), DX
         .          .    10cc429: MOVQ 0x38(CX), CX
         .          .    10cc42d: MOVQ DX, 0(SP)
         .       30ms    10cc431: CALL CX                                 ;main.(*index).add index.go:39
         .          .    10cc433: MOVQ 0x8(SP), AX                        ;index.go:39
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      10ms       10ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:40
         .          .    10cc459: MOVQ 0x18(CX), SI                       ;index.go:40
         .          .    10cc45d: CMPQ SI, DX
         .          .    10cc460: JAE 0x10cc543
         .          .    10cc466: LEAQ 0(DX)(DX*2), SI
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI
     150ms      150ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
         .          .    10cc474: MOVQ 0(BX)(SI*8), R9                    ;index.go:40
         ...
         .      730ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
         ...
         .       10ms    10cc529: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:126
         .          .    10cc52e: JMP 0x10cc3ca                           ;index.go:126
...
ROUTINE ======================== main.(*index).near
      60ms      470ms (flat, cum)  8.36% of Total
         .          .    10cc900: MOVQ GS:0x30, CX                        ;index.go:96
         ...
         .          .    10cc9bf: CALL CX
         .          .    10cc9c1: MOVQ 0x218(SP), AX                      ;index.go:101
         .          .    10cc9c9: MOVQ 0(AX), CX
         .          .    10cc9cc: MOVQ 0x8(AX), DX
         .          .    10cc9d0: MOVQ 0x38(CX), CX
         .          .    10cc9d4: MOVQ DX, 0(SP)
         .       10ms    10cc9d8: CALL CX                                 ;main.(*index).near index.go:101
         .          .    10cc9da: MOVQ 0x8(SP), AX                        ;index.go:101
         ...
         .          .    10cca0f: MOVQ 0x28(CX), SI                       ;index.go:102
         ...
         .          .    10cca3e: MOVQ 0x220(SP), R9                      ;index.go:103
         .          .    10cca46: XORL AX, AX
         .          .    10cca48: JMP 0x10cca8a
         .          .    10cca4a: MOVQ AX, R10                            ;index.go:108
         .          .    10cca4d: SHLQ $0x3, AX
         .          .    10cca51: MOVQ DX, 0x78(SP)(AX*1)
         .          .    10cca56: MOVQ 0x228(SP), R11                     ;index.go:103
         .          .    10cca5e: MOVQ 0x200(SP), R12
         .          .    10cca66: MOVQ 0x48(SP), R13
         .          .    10cca6b: MOVQ 0x68(SP), R14
         .          .    10cca70: MOVQ 0x220(SP), R15
         .          .    10cca78: MOVQ R13, DX                            ;index.go:123
         .          .    10cca7b: MOVQ R12, SI                            ;index.go:124
         .          .    10cca7e: MOVQ R11, DI                            ;index.go:103
         .          .    10cca81: MOVQ R14, R8                            ;index.go:124
         .          .    10cca84: MOVQ R15, R9                            ;index.go:125
         .          .    10cca87: MOVQ R10, AX                            ;index.go:103
         .          .    10cca8a: CMPQ DI, AX
         .          .    10cca8d: JGE 0x10ccbf6
         .          .    10cca93: NOPL                                    ;index.go:104
         .          .    10cca94: CMPQ DX, AX                             ;index.go:123
         .          .    10cca97: JA 0x10ccd10
         .          .    10cca9d: CMPQ R8, AX                             ;index.go:124
         .          .    10ccaa0: JA 0x10ccd08
         .          .    10ccaa6: MOVQ AX, 0x40(SP)                       ;index.go:103
         .          .    10ccaab: SUBQ AX, R8                             ;index.go:124
         ...
         .          .    10ccb38: MOVQ 0x218(SP), AX                      ;index.go:106
         .          .    10ccb40: MOVQ 0(AX), CX
         .          .    10ccb43: MOVQ 0x8(AX), DX
         .          .    10ccb47: MOVQ 0x20(CX), CX
         .          .    10ccb4b: MOVQ DX, 0(SP)
         .       10ms    10ccb4f: CALL CX                                 ;main.(*index).near index.go:106
         .          .    10ccb51: MOVQ 0x218(SP), AX                      ;index.go:107
         .          .    10ccb59: MOVQ 0(AX), CX
         .          .    10ccb5c: MOVQ 0x8(AX), DX
         .          .    10ccb60: MOVQ 0x40(CX), CX
         .          .    10ccb64: MOVQ DX, 0(SP)
      10ms       10ms    10ccb68: MOVQ 0x200(SP), DX                      ;main.(*index).near index.go:107
         .          .    10ccb70: MOVQ DX, 0x8(SP)                        ;index.go:107
         .          .    10ccb75: MOVQ 0x68(SP), BX
         .          .    10ccb7a: MOVQ BX, 0x10(SP)
         .          .    10ccb7f: MOVQ 0x48(SP), SI
         .          .    10ccb84: MOVQ SI, 0x18(SP)
         .       40ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:107
         .          .    10ccb8b: MOVQ 0x218(SP), AX                      ;index.go:108
         .          .    10ccb93: MOVQ 0(AX), CX
         .          .    10ccb96: MOVQ 0x8(AX), DX
         .          .    10ccb9a: MOVQ 0x38(CX), CX
         .          .    10ccb9e: MOVQ DX, 0(SP)
         .       20ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:108
         .          .    10ccba4: MOVQ 0x8(SP), AX                        ;index.go:108
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      40ms       40ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:108
         .          .    10ccbcb: MOVQ 0x60(SP), BX                       ;index.go:108
         .          .    10ccbd0: CMPQ BX, AX
         .          .    10ccbd3: JB 0x10cca4a
         .          .    10ccbd9: JMP 0x10cccfb
         .          .    10ccbde: MOVQ R8, 0(SP)                          ;index.go:126
         .          .    10ccbe2: MOVQ CX, 0x8(SP)
         .          .    10ccbe7: MOVQ BX, 0x10(SP)
         .          .    10ccbec: CALL runtime.memmove(SB)
         .          .    10ccbf1: JMP 0x10ccb38
         .          .    10ccbf6: MOVQ 0x248(SP), DX                      ;index.go:112
         ...
         .          .    10ccc15: INCQ AX
         .          .    10ccc18: MOVQ R11, DX                            ;index.go:116
         .          .    10ccc1b: MOVQ SI, R8
         .          .    10ccc1e: MOVQ R10, SI
         .          .    10ccc21: CMPQ BX, AX                             ;index.go:112
         .          .    10ccc24: JGE 0x10cccd5
         .          .    10ccc2a: MOVQ 0x78(SP)(AX*8), R9                 ;index.go:113
         .          .    10ccc2f: MOVQ 0x10(CX), R10                      ;index.go:114
         .          .    10ccc33: MOVQ 0x18(CX), R11
         .          .    10ccc37: CMPQ R11, R9
         .          .    10ccc3a: JAE 0x10cccf0
         .          .    10ccc40: LEAQ 0(R9)(R9*2), R9
         .          .    10ccc44: MOVQ 0x8(R10)(R9*8), R11
      10ms       10ms    10ccc49: MOVQ 0(R10)(R9*8), R9                   ;main.(*index).near index.go:114
         .          .    10ccc4d: CMPQ SI, R8                             ;index.go:116
         ...
         .          .    10ccc80: MOVQ AX, 0x58(SP)                       ;index.go:112
         .          .    10ccc85: MOVQ SI, 0x50(SP)                       ;index.go:116
         .          .    10ccc8a: MOVQ DX, 0(SP)
         .          .    10ccc8e: MOVQ R9, 0x8(SP)
         .          .    10ccc93: SHLQ $0x3, SI
         .          .    10ccc97: MOVQ SI, 0x10(SP)
         .      330ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
         .          .    10ccca1: MOVQ 0x58(SP), AX                       ;index.go:112
         .          .    10ccca6: MOVQ 0x218(SP), CX                      ;index.go:114
         .          .    10cccae: MOVQ 0x60(SP), BX                       ;index.go:112
         .          .    10cccb3: MOVQ 0x50(SP), SI                       ;index.go:116
...
ROUTINE ======================== main.(*index).nearCount
     100ms      190ms (flat, cum)  3.38% of Total
         .          .    10cc570: MOVQ GS:0x30, CX                        ;index.go:58
         ...
         .          .    10cc5a2: LEAQ 0x68(SP), DI                       ;index.go:59
         .          .    10cc5a7: XORPS X0, X0
         .          .    10cc5aa: MOVQ BP, -0x10(SP)
         .          .    10cc5af: LEAQ -0x10(SP), BP
         .       10ms    10cc5b4: CALL 0x105866e                          ;main.(*index).nearCount index.go:59
         .          .    10cc5b9: MOVQ 0(BP), BP                          ;index.go:59
         .          .    10cc5bd: MOVQ 0x218(SP), AX                      ;index.go:60
         .          .    10cc5c5: LEAQ 0x1(AX), CX
         .          .    10cc5c9: CMPQ $0x30, CX
         .          .    10cc5cd: JA 0x10cc8e8
         .          .    10cc5d3: MOVQ CX, 0x50(SP)
         .          .    10cc5d8: MOVQ 0x208(SP), AX                      ;index.go:61
         .          .    10cc5e0: MOVQ 0(AX), CX
         .          .    10cc5e3: MOVQ 0x8(AX), DX
         .          .    10cc5e7: MOVQ 0x20(CX), CX
         .          .    10cc5eb: MOVQ DX, 0(SP)
         .          .    10cc5ef: CALL CX
         .          .    10cc5f1: MOVQ 0x208(SP), AX                      ;index.go:62
         ...
         .       20ms    10cc62f: CALL CX                                 ;main.(*index).nearCount index.go:62
         .          .    10cc631: MOVQ 0x208(SP), AX                      ;index.go:63
         .          .    10cc639: MOVQ 0(AX), CX
         .          .    10cc63c: MOVQ 0x8(AX), DX
         .          .    10cc640: MOVQ 0x38(CX), CX
      10ms       10ms    10cc644: MOVQ DX, 0(SP)                          ;main.(*index).nearCount index.go:63
         .       10ms    10cc648: CALL CX
         .          .    10cc64a: MOVQ 0x8(SP), AX                        ;index.go:63
         ...
         .          .    10cc67f: MOVQ 0x38(CX), DX                       ;index.go:64
         ...
         .          .    10cc6ae: MOVQ 0x210(SP), R9                      ;index.go:65
         .          .    10cc6b6: XORL AX, AX
         .          .    10cc6b8: JMP 0x10cc6fa
      10ms       10ms    10cc6ba: MOVQ AX, R10                            ;main.(*index).nearCount index.go:70
         .          .    10cc6bd: SHLQ $0x3, AX                           ;index.go:70
         .          .    10cc6c1: MOVQ DX, 0x68(SP)(AX*1)
         .          .    10cc6c6: MOVQ 0x218(SP), R11                     ;index.go:65
         .          .    10cc6ce: MOVQ 0x1f0(SP), R12
         .          .    10cc6d6: MOVQ 0x48(SP), R13
         .          .    10cc6db: MOVQ 0x58(SP), R14
         .          .    10cc6e0: MOVQ 0x210(SP), R15
         .          .    10cc6e8: MOVQ R13, DX                            ;index.go:123
         .          .    10cc6eb: MOVQ R12, SI                            ;index.go:124
         .          .    10cc6ee: MOVQ R11, DI                            ;index.go:65
         .          .    10cc6f1: MOVQ R14, R8                            ;index.go:124
         .          .    10cc6f4: MOVQ R15, R9                            ;index.go:125
         .          .    10cc6f7: MOVQ R10, AX                            ;index.go:65
         .          .    10cc6fa: CMPQ DI, AX
         .          .    10cc6fd: JGE 0x10cc863
         .          .    10cc703: NOPL                                    ;index.go:66
         .          .    10cc704: CMPQ DX, AX                             ;index.go:123
         .          .    10cc707: JA 0x10cc8c9
         .          .    10cc70d: CMPQ R8, AX                             ;index.go:124
         .          .    10cc710: JA 0x10cc8c1
         .          .    10cc716: MOVQ AX, 0x40(SP)                       ;index.go:65
         .          .    10cc71b: SUBQ AX, R8                             ;index.go:124
      ...
      10ms       10ms    10cc7a8: MOVQ 0x208(SP), AX                      ;main.(*index).nearCount index.go:68
         .          .    10cc7b0: MOVQ 0(AX), CX                          ;index.go:68
         .          .    10cc7b3: MOVQ 0x8(AX), DX
         .          .    10cc7b7: MOVQ 0x20(CX), CX
         .          .    10cc7bb: MOVQ DX, 0(SP)
         .       10ms    10cc7bf: CALL CX                                 ;main.(*index).nearCount index.go:68
         .          .    10cc7c1: MOVQ 0x208(SP), AX                      ;index.go:69
      10ms       10ms    10cc7c9: MOVQ 0(AX), CX                          ;main.(*index).nearCount index.go:69
         .          .    10cc7cc: MOVQ 0x8(AX), DX                        ;index.go:69
         ...
         .       10ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:69
         .          .    10cc7fb: MOVQ 0x208(SP), AX                      ;index.go:70
         .          .    10cc803: MOVQ 0(AX), CX
         .          .    10cc806: MOVQ 0x8(AX), DX
         .          .    10cc80a: MOVQ 0x38(CX), CX
         .          .    10cc80e: MOVQ DX, 0(SP)
         .       30ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:70
         .          .    10cc814: MOVQ 0x8(SP), AX                        ;index.go:70
         ...
         .          .    10cc831: XORL DX, DX
         .          .    10cc833: DIVQ BX
      20ms       20ms    10cc836: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:70
         .          .    10cc83b: MOVQ 0x50(SP), BX                       ;index.go:70
         .          .    10cc840: CMPQ BX, AX
         .          .    10cc843: JB 0x10cc6ba
         .          .    10cc849: JMP 0x10cc8b4
         .          .    10cc84b: MOVQ R8, 0(SP)                          ;index.go:126
...
ROUTINE ======================== main.LoadDictionary
      60ms      2.98s (flat, cum) 53.02% of Total
         ...
         .       10ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
      ...
      30ms       30ms    10ca180: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .       40ms    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
         ...
         .      1.01s    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.72s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
     110ms      110ms (flat, cum)  1.96% of Total
      ...
      20ms       20ms    10cb34f: CMOVNE R11, BX                          ;main.distance graph.go:295
      ...
      10ms       10ms    10cb365: CMPQ DI, AX                             ;main.distance graph.go:294
         .          .    10cb368: JB 0x10cb343                            ;graph.go:294
         ...
         .          .    10cb38e: INT $0x3
ROUTINE ======================== main.main
         0      3.01s (flat, cum) 53.56% of Total
         ...
         .      2.98s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     100ms      120ms (flat, cum)  2.14% of Total
         ...
         .       20ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:18
      ...
      80ms       80ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:20
      20ms       20ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
         .          .    10cc0e1: LEAQ 0(BX)(CX*8), DI                    ;index.go:20
...
ROUTINE ======================== runtime.main
         ...
         .      2.99s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
