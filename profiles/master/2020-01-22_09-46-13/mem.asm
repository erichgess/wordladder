...
ROUTINE ======================== main.(*Graph).buildAdjList
  345.64MB   345.64MB (flat, cum) 43.22% of Total
   ...
   60.51MB    60.51MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  227.11MB   227.11MB    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
  107.50MB   107.50MB (flat, cum) 13.44% of Total
  ...
  107.50MB   107.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.LoadDictionary
  153.48MB   798.62MB (flat, cum) 99.86% of Total
  ...
  124.59MB   124.59MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   107.50MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   345.64MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   799.78MB (flat, cum)   100% of Total
         ...
         .   798.62MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.01% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   799.78MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
