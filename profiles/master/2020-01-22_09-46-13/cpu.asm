...
ROUTINE ======================== main.(*Graph).buildAdjList
     520ms      1.73s (flat, cum) 31.98% of Total
     ...
     430ms      430ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      20ms       20ms    10ca75e: MOVQ 0x8(R12)(AX*8), R8
         ...
         .       70ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca7da: MOVQ DI, 0x8(BX)(SI*8)                  ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca7df: MOVQ 0x58(SP), BX                       ;graph.go:112
      ...
      20ms       20ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      230ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      150ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      60ms      690ms (flat, cum) 12.75% of Total
         ...
         .       20ms    10cc418: CALL CX                                 ;main.(*index).add index.go:38
         ...
         .          .    10cc450: XORL DX, DX
         .          .    10cc452: DIVQ BX
      30ms       30ms    10cc455: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:40
      ...
      20ms       20ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
         ...
         .      610ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
         ...
         .          .    10cc501: MOVQ SI, BX
         .          .    10cc504: MOVQ DX, SI
      10ms       10ms    10cc507: JMP 0x10cc2cf                           ;main.(*index).add index.go:40
         .          .    10cc50c: MOVQ 0x80(SP), DI                       ;index.go:40
...
ROUTINE ======================== main.(*index).near
      80ms      500ms (flat, cum)  9.24% of Total
      ...
      10ms       10ms    10cc98c: MOVQ 0x8(AX), DX                        ;main.(*index).near index.go:100
         .          .    10cc990: MOVQ 0x40(CX), CX                       ;index.go:100
      ...
      10ms       10ms    10ccb59: MOVQ 0(AX), CX                          ;main.(*index).near index.go:107
         .          .    10ccb5c: MOVQ 0x8(AX), DX                        ;index.go:107
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      50ms       50ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:108
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:116
         ...
         .      370ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
...
ROUTINE ======================== main.(*index).nearCount
      80ms      150ms (flat, cum)  2.77% of Total
      ...
      10ms       10ms    10cc7ef: MOVQ 0x48(SP), SI                       ;main.(*index).nearCount index.go:69
         .          .    10cc7f4: MOVQ SI, 0x18(SP)                       ;index.go:69
         .       40ms    10cc7f9: CALL CX                                 ;main.(*index).nearCount index.go:69
         ...
         .       20ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:70
         ...
         .          .    10cc863: XORL AX, AX
      10ms       10ms    10cc865: XORL DX, DX                             ;main.skipOneCopy index.go:126
...
ROUTINE ======================== main.LoadDictionary
         0      2.73s (flat, cum) 50.46% of Total
         ...
         .       90ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
         ...
         .       10ms    10ca2b8: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:71
         ...
         .      1.73s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      70ms       70ms (flat, cum)  1.29% of Total
...
ROUTINE ======================== main.newIndex
      40ms      100ms (flat, cum)  1.85% of Total
      ...
      10ms       10ms    10cc09a: CMPQ DX, CX                             ;main.newIndex index.go:19
         .          .    10cc09d: JGE 0x10cc104                           ;index.go:19
      ...
      10ms       10ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
         ...
         .       10ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:20
...
ROUTINE ======================== runtime.main
         ...
         .      2.73s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
