...
ROUTINE ======================== main.(*Graph).buildAdjList
  353.63MB   353.63MB (flat, cum) 43.97% of Total
   ...
   56.51MB    56.51MB    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   67.51MB    67.51MB    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  229.61MB   229.61MB    10ca7cc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
   98.50MB    98.50MB (flat, cum) 12.25% of Total
   ...
   98.50MB    98.50MB    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.LoadDictionary
  160.07MB   804.20MB (flat, cum)   100% of Total
      ...
      10MB       10MB    10c9f61: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  127.18MB   127.18MB    10ca02a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10ca0a2: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .    98.50MB    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   353.63MB    10ca287: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca45e: INT $0x3
ROUTINE ======================== main.main
         0   804.20MB (flat, cum)   100% of Total
         ...
         .   804.20MB    10cd4ef: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.87% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   804.20MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
