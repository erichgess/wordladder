...
ROUTINE ======================== main.(*Graph).buildAdjList
  360.15MB   360.15MB (flat, cum) 45.31% of Total
   ...
   58.52MB    58.52MB    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   65.02MB    65.02MB    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
  ...
  236.61MB   236.61MB    10ca7cc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      87MB       87MB (flat, cum) 10.95% of Total
      ...
      87MB       87MB    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.LoadDictionary
  155.72MB   794.87MB (flat, cum)   100% of Total
       ...
       8MB        8MB    10c9f61: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
  ...
  124.83MB   124.83MB    10ca02a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10ca0a2: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .       87MB    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   360.15MB    10ca287: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca45e: INT $0x3
ROUTINE ======================== main.main
         0   794.87MB (flat, cum)   100% of Total
         ...
         .   794.87MB    10cd4ef: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 24.15% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   794.87MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
