...
ROUTINE ======================== main.(*Graph).buildAdjList
     590ms      1.90s (flat, cum) 34.86% of Total
      ...
      10ms       10ms    10ca4ae: MOVQ 0x98(SP), R12                      ;main.(*Graph).buildAdjList graph.go:110
         ...
         .          .    10ca4d6: MOVQ R12, SI
      20ms       20ms    10ca4d9: MOVQ R13, DI                            ;main.(*Graph).buildAdjList graph.go:111
     ...
     420ms      420ms    10ca4e8: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      10ms       10ms    10ca4ec: MOVQ 0x8(BX), R11                       ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca4f0: MOVQ 0(BX), R12                         ;graph.go:111
      ...
      10ms       10ms    10ca52c: MOVQ DX, 0x10(SP)                       ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca531: MOVQ CX, 0x18(SP)                       ;graph.go:111
         .          .    10ca536: MOVQ R8, 0x20(SP)
         .          .    10ca53b: MOVQ BX, 0x28(SP)
         .       40ms    10ca540: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca545: CMPQ $0x1, 0x30(SP)                     ;graph.go:111
      20ms       20ms    10ca54b: JNE 0x10ca71c                           ;main.(*Graph).buildAdjList graph.go:111
      10ms       10ms    10ca551: MOVQ 0xe8(SP), DX                       ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca559: MOVQ 0x18(DX), BX                       ;graph.go:112
      ...
      10ms       10ms    10ca5c5: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      180ms    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      160ms    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      160ms    10ca7a8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
...
ROUTINE ======================== main.(*index).add
      10ms      310ms (flat, cum)  5.69% of Total
         ...
         .          .    10cc210: XORL DX, DX
         .          .    10cc212: DIVQ BX
         .          .    10cc215: MOVQ 0x10(CX), BX                       ;index.go:41
         .          .    10cc219: MOVQ 0x18(CX), SI
         .          .    10cc21d: CMPQ SI, DX
         .          .    10cc220: JAE 0x10cc303
         .          .    10cc226: LEAQ 0(DX)(DX*2), SI
         .          .    10cc22a: MOVQ 0x10(BX)(SI*8), DI
      10ms       10ms    10cc22f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:41
         ...
         .      300ms    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.(*index).near
      60ms      620ms (flat, cum) 11.38% of Total
      ...
      10ms       10ms    10cc94b: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:109
         .          .    10cc953: MOVQ 0(AX), CX                          ;index.go:109
         .          .    10cc956: MOVQ 0x8(AX), DX
         .          .    10cc95a: MOVQ 0x38(CX), CX
         .          .    10cc95e: MOVQ DX, 0(SP)
         .       10ms    10cc962: CALL CX                                 ;main.(*index).near index.go:109
      ...
      10ms       10ms    10cc969: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:109
         ...
         .          .    10cc981: XORL DX, DX
         .          .    10cc983: DIVQ BX
      30ms       30ms    10cc986: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:109
      ...
      10ms       10ms    10cc9a7: MOVQ BX, 0x10(SP)                       ;main.skipOneCopy index.go:127
         .       10ms    10cc9ac: CALL runtime.memmove(SB)
         .          .    10cc9b1: JMP 0x10cc8f8                           ;index.go:127
         ...
         .      500ms    10cca5c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:117
...
ROUTINE ======================== main.(*index).nearCount
      40ms      180ms (flat, cum)  3.30% of Total
         ...
         .       20ms    10cc4c3: NOPL                                    ;main.(*index).nearCount index.go:67
      10ms       10ms    10cc4c4: CMPQ DX, AX                             ;main.skipOneCopy index.go:124
         ...
         .       40ms    10cc57f: CALL CX                                 ;main.(*index).nearCount index.go:69
         ...
         .       40ms    10cc5d2: CALL CX                                 ;main.(*index).nearCount index.go:71
      ...
      10ms       10ms    10cc5f6: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:71
         ...
         .       10ms    10cc619: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:127
         .          .    10cc61e: JMP 0x10cc568                           ;index.go:127
         .          .    10cc623: XORL AX, AX
         .          .    10cc625: XORL DX, DX
      ...
      20ms       20ms    10cc635: ADDQ SI, DX                             ;main.(*index).nearCount index.go:77
...
ROUTINE ======================== main.LoadDictionary
      10ms      2.50s (flat, cum) 45.87% of Total
         ...
         .          .    10c9fc5: MOVQ BX, 0x8(R8)(DX*8)
         .          .    10c9fca: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .      100ms    10ca02a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
         ...
         .       10ms    10ca0a2: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         .          .    10ca0a7: MOVQ 0x18(SP), AX                       ;graph.go:68
      ...
      10ms       10ms    10ca137: MOVQ $0x0, 0x10(DX)(CX*8)               ;main.LoadDictionary graph.go:70
         .          .    10ca140: LEAQ 0(DX)(CX*8), DI                    ;graph.go:70
         ...
         .      140ms    10ca19e: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
         ...
         .      310ms    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb108: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
...
ROUTINE ======================== main.main
         ...
         .      2.50s    10cd4ef: CALL main.LoadDictionary(SB)            ;main.main main.go:52
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cbe55: MOVQ 0x50(SP), DX                       ;main.newIndex index.go:20
         .          .    10cbe5a: CMPQ DX, CX                             ;index.go:20
      ...
      10ms       30ms    10cbe77: CALL runtime.makeslice(SB)              ;main.newIndex index.go:21
         .          .    10cbe7c: MOVQ 0x20(SP), AX                       ;index.go:21
         .          .    10cbe81: LEAQ 0(AX)(AX*2), CX
         .          .    10cbe85: MOVQ 0x18(SP), DX
         .          .    10cbe8a: MOVQ 0x38(SP), BX
         .          .    10cbe8f: MOVQ $0x0, 0x8(BX)(CX*8)
      30ms       30ms    10cbe98: MOVQ $0x0, 0x10(BX)(CX*8)               ;main.newIndex index.go:21
         ...
         .       40ms    10cbeba: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:21
         .          .    10cbebf: MOVQ CX, AX                             ;index.go:20
      10ms       10ms    10cbec2: JMP 0x10cbe4e                           ;main.newIndex index.go:21
