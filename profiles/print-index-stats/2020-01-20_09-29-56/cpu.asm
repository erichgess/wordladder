...
ROUTINE ======================== main.(*Graph).buildAdjList
     430ms      1.76s (flat, cum) 29.88% of Total
     ...
     320ms      320ms    10ca4e8: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca504: MOVQ R10, 0x58(SP)                      ;main.(*Graph).buildAdjList graph.go:110
         .          .    10ca509: LEAQ 0(R10)(R10*2), AX                  ;graph.go:111
         .          .    10ca50d: MOVQ AX, 0x80(SP)
         .          .    10ca515: MOVQ 0(R12)(AX*8), CX
      90ms       90ms    10ca519: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
         ...
         .       90ms    10ca540: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca5c5: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      190ms    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      170ms    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .      220ms    10ca7a8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      110ms    10ca7cc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      530ms    10ca81f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
         ...
         .       10ms    10ca860: XORPS X0, X0                            ;main.(*Graph).buildAdjList graph.go:117
         .          .    10ca863: CVTSI2SDQ CX, X0                        ;graph.go:117
         .          .    10ca868: XORPS X1, X1
         ...
         .       10ms    10ca8f0: CALL fmt.Fprintf(SB)                    ;fmt.Printf print.go:213
         .          .    10ca8f5: MOVQ 0xd8(SP), BP                       ;print.go:213
...
ROUTINE ======================== main.(*index).add
     280ms         1s (flat, cum) 16.98% of Total
         ...
         .       30ms    10cc1a1: CALL CX                                 ;main.(*index).add index.go:38
      10ms       10ms    10cc1a3: MOVQ 0xa0(SP), AX                       ;main.(*index).add index.go:39
         .          .    10cc1ab: MOVQ 0(AX), CX                          ;index.go:39
         ...
         .          .    10cc210: XORL DX, DX
         .          .    10cc212: DIVQ BX
      30ms       30ms    10cc215: MOVQ 0x10(CX), BX                       ;main.(*index).add index.go:41
         .          .    10cc219: MOVQ 0x18(CX), SI                       ;index.go:41
         .          .    10cc21d: CMPQ SI, DX
         .          .    10cc220: JAE 0x10cc303
         .          .    10cc226: LEAQ 0(DX)(DX*2), SI
         .          .    10cc22a: MOVQ 0x10(BX)(SI*8), DI
     240ms      240ms    10cc22f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:41
         ...
         .      600ms    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.(*index).near
     100ms      550ms (flat, cum)  9.34% of Total
         ...
         .       10ms    10cc73f: CALL CX                                 ;main.(*index).near index.go:100
         ...
         .       10ms    10cc77f: CALL CX                                 ;main.(*index).near index.go:101
      ...
      10ms       30ms    10cc798: CALL CX                                 ;main.(*index).near index.go:102
      ...
      10ms       10ms    10cc838: MOVQ R13, DX                            ;main.skipOneCopy index.go:124
         ...
         .       20ms    10cc853: NOPL                                    ;main.(*index).near index.go:105
         ...
         .       10ms    10cc90f: CALL CX                                 ;main.(*index).near index.go:107
      ...
      10ms       10ms    10cc953: MOVQ 0(AX), CX                          ;main.(*index).near index.go:109
         .          .    10cc956: MOVQ 0x8(AX), DX                        ;index.go:109
      ...
      10ms       10ms    10cc969: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:109
         .          .    10cc971: MOVQ 0x40(CX), DX                       ;index.go:109
         .          .    10cc975: TESTQ DX, DX
         .          .    10cc978: JE 0x10ccac3
         .          .    10cc97e: MOVQ DX, BX
         .          .    10cc981: XORL DX, DX
         .          .    10cc983: DIVQ BX
         .          .    10cc986: MOVQ 0x70(SP), AX
         .          .    10cc98b: MOVQ 0x60(SP), BX
         .          .    10cc990: CMPQ BX, AX
         .          .    10cc993: JB 0x10cc80a
         .          .    10cc999: JMP 0x10ccabb
         .          .    10cc99e: MOVQ R8, 0(SP)                          ;index.go:127
         .          .    10cc9a2: MOVQ CX, 0x8(SP)
      10ms       10ms    10cc9a7: MOVQ BX, 0x10(SP)                       ;main.skipOneCopy index.go:127
         .          .    10cc9ac: CALL runtime.memmove(SB)                ;index.go:127
      ...
      20ms       20ms    10cca0d: CMPQ SI, R8                             ;main.(*index).near index.go:117
         ...
         .      340ms    10cca5c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:117
         .          .    10cca61: MOVQ 0x58(SP), AX                       ;index.go:113
      10ms       10ms    10cca66: MOVQ 0x218(SP), CX                      ;main.(*index).near index.go:115
      ...
      10ms       10ms    10cca88: MOVQ 0x248(SP), R11                     ;main.(*index).near index.go:117
         .          .    10cca90: JMP 0x10cc9d5                           ;index.go:117
...
ROUTINE ======================== main.(*index).nearCount
     170ms      230ms (flat, cum)  3.90% of Total
      ...
      10ms       10ms    10cc520: MOVQ 0x218(SP), CX                      ;main.skipOneCopy index.go:127
         .          .    10cc528: SUBQ AX, CX                             ;index.go:127
      ...
      10ms       10ms    10cc589: MOVQ 0(AX), CX                          ;main.(*index).nearCount index.go:70
         .          .    10cc58c: MOVQ 0x8(AX), DX                        ;index.go:70
         .          .    10cc590: MOVQ 0x40(CX), CX
         .          .    10cc594: MOVQ DX, 0(SP)
      10ms       10ms    10cc598: MOVQ 0x1f0(SP), DX                      ;main.(*index).nearCount index.go:70
         .          .    10cc5a0: MOVQ DX, 0x8(SP)                        ;index.go:70
         ...
         .       10ms    10cc5d2: CALL CX                                 ;main.(*index).nearCount index.go:71
         .          .    10cc5d4: MOVQ 0x8(SP), AX                        ;index.go:71
      10ms       10ms    10cc5d9: MOVQ 0x208(SP), CX                      ;main.(*index).nearCount index.go:71
         .          .    10cc5e1: MOVQ 0x40(CX), DX                       ;index.go:71
         .          .    10cc5e5: TESTQ DX, DX
         .          .    10cc5e8: JE 0x10cc67c
         .          .    10cc5ee: MOVQ DX, BX
         .          .    10cc5f1: XORL DX, DX
         .          .    10cc5f3: DIVQ BX
      50ms       50ms    10cc5f6: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:71
      ...
      80ms       80ms    10cc635: ADDQ SI, DX                             ;main.(*index).nearCount index.go:77
...
ROUTINE ======================== main.LoadDictionary
      40ms      2.98s (flat, cum) 50.59% of Total
         ...
         .       30ms    10c9f1e: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:54
      ...
      20ms       20ms    10c9fc5: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:58
      20ms       20ms    10c9fca: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .         1s    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .      1.75s    10ca287: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      90ms       90ms (flat, cum)  1.53% of Total
         ...
         .          .    10cb0f5: MOVQ 0x38(SP), DX                       ;graph.go:286
         .          .    10cb0fa: MOVQ 0x20(SP), R8
         .          .    10cb0ff: XORL AX, AX
         .          .    10cb101: JMP 0x10cb116
         .          .    10cb103: MOVZX 0(DX)(AX*1), R10                  ;graph.go:294
      30ms       30ms    10cb108: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
      10ms       10ms    10cb10c: CMPL R10, R9                            ;main.distance graph.go:294
         .          .    10cb10f: CMOVNE R11, BX                          ;graph.go:295
      10ms       10ms    10cb113: INCQ AX                                 ;main.distance graph.go:293
         .          .    10cb116: CMPQ CX, AX                             ;graph.go:293
         .          .    10cb119: JGE 0x10cb12c
      10ms       10ms    10cb11b: CMPQ SI, AX                             ;main.distance graph.go:294
         .          .    10cb11e: JAE 0x10cb143                           ;graph.go:294
         .          .    10cb120: MOVZX 0(R8)(AX*1), R9
      20ms       20ms    10cb125: CMPQ DI, AX                             ;main.distance graph.go:294
         .          .    10cb128: JB 0x10cb103                            ;graph.go:294
         .          .    10cb12a: JMP 0x10cb13b
         .          .    10cb12c: MOVQ BX, 0x50(SP)                       ;graph.go:299
      10ms       10ms    10cb131: MOVQ 0x10(SP), BP                       ;main.distance graph.go:299
         .          .    10cb136: ADDQ $0x18, SP                          ;graph.go:299
         .          .    10cb13a: RET
...
ROUTINE ======================== main.main
         ...
         .      2.98s    10cd4ef: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .          .    10cd50e: CALL main.(*Graph).EdgeCount(SB)
         .          .    10cd513: MOVQ 0x8(SP), AX
         ...
         .          .    10cd76b: CALL runtime/pprof.writeHeapInternal(SB)
         .          .    10cd770: MOVQ 0x28(SP), AX
         .          .    10cd775: MOVQ 0x30(SP), CX
         .          .    10cd77a: TESTQ AX, AX                            ;main.go:94
         .          .    10cd77d: JE 0x10cd630
...
ROUTINE ======================== main.newIndex
     100ms      120ms (flat, cum)  2.04% of Total
      ...
      50ms       50ms    10cbe8f: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:21
      50ms       50ms    10cbe98: MOVQ $0x0, 0x10(BX)(CX*8)
...
ROUTINE ======================== runtime.main
         ...
         .      2.98s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
