...
ROUTINE ======================== main.(*Graph).buildAdjList
  395.66MB   395.66MB (flat, cum) 46.98% of Total
         ...
         .          .    10ca519: MOVQ 0x10(R12)(AX*8), BX
         .          .    10ca51e: MOVQ 0x8(R12)(AX*8), R8
         ...
         .          .    10ca540: CALL main.distance(SB)
         .          .    10ca545: CMPQ $0x1, 0x30(SP)
         ...
         .          .    10ca5c5: MOVQ 0x10(DI)(BX*8), R9
         .          .    10ca5ca: MOVQ 0x8(DI)(BX*8), R10
   ...
   56.52MB    56.52MB    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   76.52MB    76.52MB    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .          .    10ca7a8: CALL main.(*index).nearCount(SB)
         .          .    10ca7ad: MOVQ 0x20(SP), AX
  ...
  262.63MB   262.63MB    10ca7cc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .          .    10ca81f: CALL main.(*index).near(SB)
...
ROUTINE ======================== main.(*index).add
   99.50MB    99.50MB (flat, cum) 11.81% of Total
         ...
         .          .    10cc22f: MOVQ 0x8(BX)(SI*8), R8
         .          .    10cc234: MOVQ 0(BX)(SI*8), R9
   ...
   99.50MB    99.50MB    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.LoadDictionary
  153.89MB   841.06MB (flat, cum) 99.86% of Total
         ...
         .          .    10c9f1e: CALL bufio.(*Scanner).Scan(SB)
         .          .    10c9f23: CMPB $0x0, 0x8(SP)
       ...
       6MB        6MB    10c9f61: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:56
         .          .    10c9f66: MOVQ 0x18(SP), AX                       ;graph.go:56
     ...
     125MB      125MB    10ca02a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10ca0a2: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .      192MB    10ca19e: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
         ...
         .    99.50MB    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   395.66MB    10ca287: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca45e: INT $0x3
ROUTINE ======================== main.main
         0   842.22MB (flat, cum)   100% of Total
         ...
         .   841.06MB    10cd4ef: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .     1.16MB    10ce004: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:33
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 22.80% of Total
     ...
     192MB      192MB    10cbe3b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:19
         ...
         .          .    10cbe98: MOVQ $0x0, 0x10(BX)(CX*8)
         .          .    10cbea1: LEAQ 0(BX)(CX*8), DI
...
ROUTINE ======================== runtime.main
         ...
         .   842.22MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
