...
ROUTINE ======================== main.(*Graph).buildAdjList
  358.65MB   358.65MB (flat, cum) 44.35% of Total
   ...
   62.52MB    62.52MB    10ca61d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   66.51MB    66.51MB    10ca6b4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
...
ROUTINE ======================== main.(*index).add
  103.50MB   103.50MB (flat, cum) 12.80% of Total
  ...
  103.50MB   103.50MB    10cc27d: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.LoadDictionary
  153.44MB   807.59MB (flat, cum) 99.86% of Total
  ...
  124.55MB   124.55MB    10ca02a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
   ...
   22.89MB    22.89MB    10ca0a2: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:68
         ...
         .   103.50MB    10ca214: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .   358.65MB    10ca287: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca45e: INT $0x3
ROUTINE ======================== main.main
         0   808.74MB (flat, cum)   100% of Total
         ...
         .   807.59MB    10cd4af: CALL main.LoadDictionary(SB)            ;main.main main.go:52
         ...
         .     1.16MB    10cdfc4: CALL runtime/pprof.StartCPUProfile(SB)  ;main.main main.go:33
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.74% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   808.74MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
