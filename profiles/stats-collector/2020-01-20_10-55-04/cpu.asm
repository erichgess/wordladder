...
ROUTINE ======================== main.(*Graph).buildAdjList
     500ms      1.76s (flat, cum) 30.66% of Total
      ...
      10ms       10ms    10ca6e9: MOVQ 0x70(SP), R11                      ;main.(*Graph).buildAdjList graph.go:110
         .          .    10ca6ee: MOVQ 0x98(SP), R12                      ;graph.go:110
     ...
     430ms      430ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      10ms       10ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
         ...
         .       50ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
         .          .    10ca785: CMPQ $0x1, 0x30(SP)                     ;graph.go:111
      20ms       20ms    10ca78b: JNE 0x10ca95c                           ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca976: MOVQ 0x60(SP), DX                       ;main.(*Graph).buildAdjList graph.go:104
         .          .    10ca97b: LEAQ 0x1(DX), AX                        ;graph.go:104
         ...
         .      110ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .       90ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      680ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      70ms      720ms (flat, cum) 12.54% of Total
      ...
      10ms       10ms    10cc30b: MOVQ R11, DX                            ;main.skipOneCopy index.go:123
      ...
      10ms       10ms    10cc466: LEAQ 0(DX)(DX*2), SI                    ;main.(*index).add index.go:40
         .          .    10cc46a: MOVQ 0x10(BX)(SI*8), DI                 ;index.go:40
      50ms       50ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
         ...
         .      640ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.(*index).near
      50ms      680ms (flat, cum) 11.85% of Total
         ...
         .          .    10cc9f7: XORL DX, DX
         .          .    10cc9f9: DIVQ BX
      10ms       10ms    10cc9fc: MOVQ 0x60(SP), BX                       ;main.(*index).near index.go:101
         .          .    10cca01: TESTQ BX, BX                            ;index.go:101
         ...
         .       30ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:108
      ...
      10ms       10ms    10ccc8e: MOVQ R9, 0x8(SP)                        ;main.(*index).near index.go:116
         .          .    10ccc93: SHLQ $0x3, SI                           ;index.go:116
         .          .    10ccc97: MOVQ SI, 0x10(SP)
      10ms      600ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
...
ROUTINE ======================== main.(*index).nearCount
      ...
      10ms       10ms    10cc819: MOVQ 0x208(SP), CX                      ;main.(*index).nearCount index.go:70
         .          .    10cc821: MOVQ 0x40(CX), DX                       ;index.go:70
         .          .    10cc825: TESTQ DX, DX
      ...
      20ms       20ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:76
      ...
      10ms       10ms    10cc88a: CMPQ SI, R8                             ;main.(*index).nearCount index.go:75
         .          .    10cc88d: JB 0x10cc869                            ;index.go:75
...
ROUTINE ======================== main.LoadDictionary
      ...
      20ms       20ms    10ca2ed: MOVQ $0x0, 0x10(DX)(CX*8)               ;main.LoadDictionary graph.go:71
         ...
         .      710ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
...
ROUTINE ======================== main.distance
      ...
      10ms       10ms    10cb325: SUBQ DX, BX                             ;main.distance graph.go:285
...
ROUTINE ======================== main.main
         ...
         .      2.71s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cc0ab: MOVQ AX, 0(SP)                          ;main.newIndex index.go:20
         .          .    10cc0af: XORPS X0, X0                            ;index.go:20
      ...
      10ms       10ms    10cc0e1: LEAQ 0(BX)(CX*8), DI
         .          .    10cc0e5: CMPL $0x0, runtime.writeBarrier(SB)     ;index.go:20
...
ROUTINE ======================== runtime.main
         ...
         .      2.71s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
