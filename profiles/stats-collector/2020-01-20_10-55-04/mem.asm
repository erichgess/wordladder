...
ROUTINE ======================== main.(*Graph).buildAdjList
  368.64MB   368.64MB (flat, cum) 45.35% of Total
   ...
   70.52MB    70.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
...
ROUTINE ======================== main.(*index).add
      96MB       96MB (flat, cum) 11.81% of Total
      ...
      96MB       96MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.LoadDictionary
  154.51MB   811.15MB (flat, cum) 99.79% of Total
  ...
  122.11MB   122.11MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .   368.64MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   812.87MB (flat, cum)   100% of Total
         ...
         .   811.15MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== runtime.main
         ...
         .   812.87MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
