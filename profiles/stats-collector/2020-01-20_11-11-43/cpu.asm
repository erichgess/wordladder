...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     480ms      480ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      40ms       40ms    10ca759: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms      120ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      10ms       10ms    10ca785: CMPQ $0x1, 0x30(SP)
      30ms       30ms    10ca78b: JNE 0x10ca95c
      ...
      20ms       20ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      220ms    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .       70ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      380ms    10caa5f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      50ms      630ms (flat, cum) 11.75% of Total
         ...
         .       10ms    10cc32b: NOPL                                    ;main.(*index).add index.go:35
         ...
         .       10ms    10cc431: CALL CX                                 ;main.(*index).add index.go:39
      ...
      10ms       10ms    10cc474: MOVQ 0(BX)(SI*8), R9
         ...
         .      550ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
      ...
      10ms       10ms    10cc501: MOVQ SI, BX                             ;main.(*index).add index.go:40
         .          .    10cc504: MOVQ DX, SI                             ;index.go:40
...
ROUTINE ======================== main.(*index).near
      30ms      400ms (flat, cum)  7.46% of Total
         ...
         .       20ms    10cca93: NOPL                                    ;main.(*index).near index.go:104
      10ms       10ms    10cca94: CMPQ DX, AX                             ;main.skipOneCopy index.go:123
         .          .    10cca97: JA 0x10ccd10                            ;index.go:123
         ...
         .          .    10ccb0f: SUBQ AX, CX
         .          .    10ccb12: NEGQ CX
      10ms       10ms    10ccb15: SARQ $0x3f, CX                          ;main.skipOneCopy index.go:126
         .          .    10ccb19: ANDQ AX, CX                             ;index.go:126
         ...
         .          .    10ccbbe: MOVQ DX, BX
      10ms       10ms    10ccbc1: XORL DX, DX                             ;main.(*index).near index.go:108
         .          .    10ccbc3: DIVQ BX                                 ;index.go:108
         .          .    10ccbc6: MOVQ 0x70(SP), AX
         .          .    10ccbcb: MOVQ 0x60(SP), BX
         .          .    10ccbd0: CMPQ BX, AX
         ...
         .      310ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
...
ROUTINE ======================== main.(*index).nearCount
      60ms      160ms (flat, cum)  2.99% of Total
         ...
         .       10ms    10cc62f: CALL CX                                 ;main.(*index).nearCount index.go:62
         ...
         .       20ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:66
      ...
      10ms       10ms    10cc77f: SUBQ AX, CX                             ;main.skipOneCopy index.go:126
         .          .    10cc782: NEGQ CX                                 ;index.go:126
         ...
         .       40ms    10cc812: CALL CX                                 ;main.(*index).nearCount index.go:70
...
ROUTINE ======================== main.LoadDictionary
      ...
      20ms       20ms    10ca17b: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:59
         ...
         .       90ms    10ca358: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
         ...
         .      620ms    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .      1.70s    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.main
         ...
         .      2.54s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      60ms       90ms (flat, cum)  1.68% of Total
         ...
         .       10ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:20
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:20
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
         .          .    10cc0ca: MOVQ 0x38(SP), BX
      20ms       20ms    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:20
      40ms       40ms    10cc0d8: MOVQ $0x0, 0x10(BX)(CX*8)
...
ROUTINE ======================== runtime.main
         ...
         .      2.54s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
