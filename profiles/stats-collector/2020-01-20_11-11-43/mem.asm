...
ROUTINE ======================== main.(*Graph).buildAdjList
  380.14MB   380.14MB (flat, cum) 46.47% of Total
   ...
   71.52MB    71.52MB    10ca85d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
   ...
   73.01MB    73.01MB    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
...
ROUTINE ======================== main.(*index).add
   93.50MB    93.50MB (flat, cum) 11.43% of Total
   ...
   93.50MB    93.50MB    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.LoadDictionary
  151.25MB   816.90MB (flat, cum) 99.86% of Total
  ...
  122.86MB   122.86MB    10ca1e0: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:59
   ...
   22.89MB    22.89MB    10ca258: CALL runtime.makeslice(SB)              ;main.LoadDictionary graph.go:69
         ...
         .    93.50MB    10ca3ce: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:77
         ...
         .   380.14MB    10ca441: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
         ...
         .          .    10ca69e: INT $0x3
ROUTINE ======================== main.main
         0   818.05MB (flat, cum)   100% of Total
         ...
         .   816.90MB    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
     192MB      192MB (flat, cum) 23.47% of Total
...
ROUTINE ======================== runtime.main
         ...
         .   818.05MB    102cd0c: CALL AX                                 ;runtime.main proc.go:203
