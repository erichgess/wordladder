...
ROUTINE ======================== main.(*Graph).buildAdjList
     490ms      1.88s (flat, cum) 34.31% of Total
     ...
     350ms      350ms    10ca728: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      20ms       20ms    10ca75e: MOVQ 0x8(R12)(AX*8), R8
         ...
         .       90ms    10ca780: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      20ms       20ms    10ca805: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      260ms    10ca8f4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
         ...
         .       90ms    10ca9e8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      220ms    10caa0c: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
...
ROUTINE ======================== main.(*index).add
      40ms      690ms (flat, cum) 12.59% of Total
      ...
      10ms       10ms    10cc322: CMPQ DI, AX                             ;main.(*index).add index.go:34
         .          .    10cc325: JGE 0x10cc533                           ;index.go:34
      ...
      20ms       20ms    10cc46f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:40
      10ms       10ms    10cc474: MOVQ 0(BX)(SI*8), R9
         .          .    10cc478: LEAQ 0x1(R8), R10                       ;index.go:40
         ...
         .      620ms    10cc4bd: CALL runtime.growslice(SB)              ;main.(*index).add index.go:40
...
ROUTINE ======================== main.(*index).near
      80ms      590ms (flat, cum) 10.77% of Total
      ...
      10ms       10ms    10cca78: MOVQ R13, DX                            ;main.skipOneCopy index.go:123
         ...
         .       30ms    10cca93: NOPL                                    ;main.(*index).near index.go:104
      ...
      10ms       10ms    10ccaae: MOVQ R8, 0x38(SP)                       ;main.skipOneCopy index.go:124
         .          .    10ccab3: SUBQ AX, DX                             ;index.go:124
         .          .    10ccab6: NEGQ DX
      ...
      10ms       10ms    10ccb51: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:107
         .          .    10ccb59: MOVQ 0(AX), CX                          ;index.go:107
      ...
      10ms       10ms    10ccb68: MOVQ 0x200(SP), DX                      ;main.(*index).near index.go:107
         ...
         .       20ms    10ccb89: CALL CX                                 ;main.(*index).near index.go:107
         ...
         .       40ms    10ccba2: CALL CX                                 ;main.(*index).near index.go:108
         ...
         .          .    10ccbc1: XORL DX, DX
         .          .    10ccbc3: DIVQ BX
      20ms       20ms    10ccbc6: MOVQ 0x70(SP), AX                       ;main.(*index).near index.go:108
         ...
         .       10ms    10ccbec: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:126
         .          .    10ccbf1: JMP 0x10ccb38                           ;index.go:126
      ...
      10ms       10ms    10ccc4d: CMPQ SI, R8                             ;main.(*index).near index.go:116
         .          .    10ccc50: JA 0x10ccce5                            ;index.go:116
         .          .    10ccc56: MOVQ SI, R10
         .          .    10ccc59: SUBQ R8, SI
         .          .    10ccc5c: CMPQ R11, SI
         ...
         .      390ms    10ccc9c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:116
      ...
      10ms       10ms    10cccc8: MOVQ 0x248(SP), R11                     ;main.(*index).near index.go:116
         .          .    10cccd0: JMP 0x10ccc15                           ;index.go:116
...
ROUTINE ======================== main.(*index).nearCount
      50ms      120ms (flat, cum)  2.19% of Total
         ...
         .       10ms    10cc648: CALL CX                                 ;main.(*index).nearCount index.go:63
         ...
         .       30ms    10cc703: NOPL                                    ;main.(*index).nearCount index.go:66
         ...
         .       10ms    10cc74e: CALL runtime.memmove(SB)                ;main.skipOneCopy index.go:125
         .          .    10cc753: MOVQ 0x40(SP), AX                       ;index.go:126
         .          .    10cc758: INCQ AX
         .          .    10cc75b: MOVQ AX, 0x60(SP)
      10ms       10ms    10cc760: MOVQ 0x218(SP), CX                      ;main.skipOneCopy index.go:126
         .          .    10cc768: SUBQ AX, CX                             ;index.go:126
         .          .    10cc76b: MOVQ 0x38(SP), BX
      10ms       10ms    10cc770: CMPQ CX, BX                             ;main.skipOneCopy index.go:126
         .          .    10cc773: CMOVG CX, BX                            ;index.go:126
      ...
      10ms       10ms    10cc875: ADDQ SI, DX                             ;main.(*index).nearCount index.go:76
...
ROUTINE ======================== main.LoadDictionary
      10ms      2.86s (flat, cum) 52.19% of Total
         ...
         .       20ms    10ca0d4: CALL bufio.(*Scanner).Scan(SB)          ;main.LoadDictionary graph.go:55
      ...
      10ms       10ms    10ca17b: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:59
         ...
         .      150ms    10ca358: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:75
...
ROUTINE ======================== main.distance
      90ms       90ms (flat, cum)  1.64% of Total
      ...
      70ms       70ms    10cb348: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
      ...
      10ms       10ms    10cb365: CMPQ DI, AX                             ;main.distance graph.go:294
         ...
         .          .    10cb38e: INT $0x3
ROUTINE ======================== main.main
         0      2.86s (flat, cum) 52.19% of Total
         ...
         .      2.86s    10cdbbc: CALL main.LoadDictionary(SB)            ;main.main main.go:55
...
ROUTINE ======================== main.newIndex
      20ms      150ms (flat, cum)  2.74% of Total
         ...
         .       80ms    10cc07b: CALL runtime.makeslice(SB)              ;main.newIndex index.go:18
         ...
         .       30ms    10cc0b7: CALL runtime.makeslice(SB)              ;main.newIndex index.go:20
         .          .    10cc0bc: MOVQ 0x20(SP), AX                       ;index.go:20
         .          .    10cc0c1: LEAQ 0(AX)(AX*2), CX
         .          .    10cc0c5: MOVQ 0x18(SP), DX
      10ms       10ms    10cc0ca: MOVQ 0x38(SP), BX                       ;main.newIndex index.go:20
         .          .    10cc0cf: MOVQ $0x0, 0x8(BX)(CX*8)                ;index.go:20
         ...
         .       20ms    10cc0fa: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:20
         .          .    10cc0ff: MOVQ CX, AX                             ;index.go:19
      10ms       10ms    10cc102: JMP 0x10cc08e                           ;main.newIndex index.go:20
...
ROUTINE ======================== runtime.main
         ...
         .      2.86s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
