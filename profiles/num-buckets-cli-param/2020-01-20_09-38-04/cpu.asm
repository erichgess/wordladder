...
ROUTINE ======================== main.(*Graph).buildAdjList
     ...
     480ms      480ms    10ca618: MOVQ 0(R8)(R9*8), R10                   ;main.(*Graph).buildAdjList graph.go:110
      ...
      30ms       30ms    10ca649: MOVQ 0x10(R12)(AX*8), BX                ;main.(*Graph).buildAdjList graph.go:111
      10ms       10ms    10ca64e: MOVQ 0x8(R12)(AX*8), R8
         .          .    10ca653: MOVQ SI, 0(SP)                          ;graph.go:111
         .          .    10ca657: MOVQ DI, 0x8(SP)
         .          .    10ca65c: MOVQ DX, 0x10(SP)
         .          .    10ca661: MOVQ CX, 0x18(SP)
         .          .    10ca666: MOVQ R8, 0x20(SP)
         .          .    10ca66b: MOVQ BX, 0x28(SP)
         .       80ms    10ca670: CALL main.distance(SB)                  ;main.(*Graph).buildAdjList graph.go:111
      ...
      10ms       10ms    10ca68d: MOVQ 0x20(DX), CX                       ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca691: MOVQ 0x60(SP), AX                       ;graph.go:112
         .          .    10ca696: CMPQ CX, AX
      ...
      10ms       10ms    10ca6b1: MOVQ 0(BX)(SI*8), R9                    ;main.(*Graph).buildAdjList graph.go:112
         .          .    10ca6b5: LEAQ 0x1(R8), R10                       ;graph.go:112
      ...
      20ms       20ms    10ca6f5: MOVQ 0x10(DI)(BX*8), R9                 ;main.(*Graph).buildAdjList graph.go:113
      10ms       10ms    10ca6fa: MOVQ 0x8(DI)(BX*8), R10
         .          .    10ca6ff: LEAQ 0x1(R10), R11                      ;graph.go:113
      ...
      10ms       10ms    10ca719: JMP 0x10ca5c8                           ;main.(*Graph).buildAdjList graph.go:113
         .          .    10ca71e: MOVQ R12, 0xb8(SP)                      ;graph.go:113
         ...
         .      240ms    10ca74d: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:113
         ...
         .      200ms    10ca7e4: CALL runtime.growslice(SB)              ;main.(*Graph).buildAdjList graph.go:112
      ...
      10ms       10ms    10ca84c: MOVQ 0x60(SP), AX                       ;main.(*Graph).buildAdjList graph.go:104
         ...
         .      160ms    10ca8d8: CALL main.(*index).nearCount(SB)        ;main.(*Graph).buildAdjList graph.go:106
         ...
         .      110ms    10ca8fc: CALL runtime.makeslice(SB)              ;main.(*Graph).buildAdjList graph.go:108
         ...
         .      580ms    10ca94f: CALL main.(*index).near(SB)             ;main.(*Graph).buildAdjList graph.go:109
...
ROUTINE ======================== main.(*index).add
      ...
      10ms       10ms    10cc35f: MOVQ 0x8(BX)(SI*8), R8                  ;main.(*index).add index.go:41
         ...
         .      280ms    10cc3ad: CALL runtime.growslice(SB)              ;main.(*index).add index.go:41
...
ROUTINE ======================== main.(*index).near
      70ms      600ms (flat, cum) 11.21% of Total
         ...
         .       10ms    10cc834: CALL 0x105866e                          ;main.(*index).near index.go:98
         .          .    10cc839: MOVQ 0(BP), BP                          ;index.go:98
         ...
         .          .    10cc86f: CALL CX
      10ms       10ms    10cc871: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:101
         .          .    10cc879: MOVQ 0(AX), CX                          ;index.go:101
      ...
      10ms       10ms    10cc8aa: MOVQ SI, 0x18(SP)                       ;main.(*index).near index.go:101
         .       20ms    10cc8af: CALL CX
         ...
         .       20ms    10cc983: NOPL                                    ;main.(*index).near index.go:105
      10ms       10ms    10cc984: CMPQ DX, AX                             ;main.skipOneCopy index.go:124
         .          .    10cc987: JA 0x10ccc00                            ;index.go:124
         ...
         .          .    10cc9ff: SUBQ AX, CX
         .          .    10cca02: NEGQ CX
      10ms       10ms    10cca05: SARQ $0x3f, CX                          ;main.skipOneCopy index.go:127
         .          .    10cca09: ANDQ AX, CX                             ;index.go:127
         ...
         .          .    10cca3f: CALL CX
      10ms       10ms    10cca41: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:108
         .          .    10cca49: MOVQ 0(AX), CX                          ;index.go:108
      ...
      10ms       10ms    10cca7b: MOVQ 0x218(SP), AX                      ;main.(*index).near index.go:109
         .          .    10cca83: MOVQ 0(AX), CX                          ;index.go:109
         ...
         .          .    10ccab1: XORL DX, DX
         .          .    10ccab3: DIVQ BX
         .          .    10ccab6: MOVQ 0x70(SP), AX
         .          .    10ccabb: MOVQ 0x60(SP), BX
         .          .    10ccac0: CMPQ BX, AX
      ...
      10ms       10ms    10ccb3d: CMPQ SI, R8                             ;main.(*index).near index.go:117
         ...
         .          .    10ccb83: SHLQ $0x3, SI
         .          .    10ccb87: MOVQ SI, 0x10(SP)
         .      430ms    10ccb8c: CALL runtime.memmove(SB)                ;main.(*index).near index.go:117
...
ROUTINE ======================== main.(*index).nearCount
     130ms      180ms (flat, cum)  3.36% of Total
      ...
      10ms       10ms    10cc497: XORPS X0, X0                            ;main.(*index).nearCount index.go:60
         ...
         .       10ms    10cc4df: CALL CX                                 ;main.(*index).nearCount index.go:62
         ...
         .       10ms    10cc538: CALL CX                                 ;main.(*index).nearCount index.go:64
         .          .    10cc53a: MOVQ 0x8(SP), AX                        ;index.go:64
      ...
      10ms       10ms    10cc5d8: MOVQ R13, DX                            ;main.skipOneCopy index.go:124
         ...
         .       20ms    10cc5f3: NOPL                                    ;main.(*index).nearCount index.go:67
      ...
      10ms       10ms    10cc660: CMPQ CX, BX                             ;main.skipOneCopy index.go:127
         .          .    10cc663: CMOVG CX, BX                            ;index.go:127
         ...
         .       10ms    10cc6e9: CALL CX                                 ;main.(*index).nearCount index.go:70
         .          .    10cc6eb: MOVQ 0x208(SP), AX                      ;index.go:71
         .          .    10cc6f3: MOVQ 0(AX), CX
         .          .    10cc6f6: MOVQ 0x8(AX), DX
         .          .    10cc6fa: MOVQ 0x38(CX), CX
      10ms       10ms    10cc6fe: MOVQ DX, 0(SP)                          ;main.(*index).nearCount index.go:71
         .          .    10cc702: CALL CX                                 ;index.go:71
         ...
         .          .    10cc721: XORL DX, DX
         .          .    10cc723: DIVQ BX
      30ms       30ms    10cc726: MOVQ 0x60(SP), AX                       ;main.(*index).nearCount index.go:71
      ...
      60ms       60ms    10cc765: ADDQ SI, DX                             ;main.(*index).nearCount index.go:77
         .          .    10cc768: CMPQ BX, AX                             ;index.go:75
         .          .    10cc76b: JGE 0x10cc781
...
ROUTINE ======================== main.LoadDictionary
      ...
      40ms       40ms    10ca0f5: MOVQ BX, 0x8(R8)(DX*8)                  ;main.LoadDictionary graph.go:58
      20ms       20ms    10ca0fa: MOVQ BX, 0x10(R8)(DX*8)
         ...
         .       90ms    10ca15a: CALL runtime.growslice(SB)              ;main.LoadDictionary graph.go:58
         ...
         .          .    10ca1d2: CALL runtime.makeslice(SB)
         .          .    10ca1d7: MOVQ 0x18(SP), AX
         ...
         .      120ms    10ca2d2: CALL main.newIndex(SB)                  ;main.LoadDictionary graph.go:74
         ...
         .      290ms    10ca348: CALL main.(*index).add(SB)              ;main.LoadDictionary graph.go:76
         ...
         .      1.97s    10ca3bb: CALL main.(*Graph).buildAdjList(SB)     ;main.LoadDictionary graph.go:88
...
ROUTINE ======================== main.distance
      80ms       80ms (flat, cum)  1.50% of Total
         ...
         .          .    10cb1f4: MOVQ BP, 0x10(SP)
         .          .    10cb1f9: LEAQ 0x10(SP), BP
         .          .    10cb1fe: MOVQ 0x28(SP), CX                       ;graph.go:290
         .          .    10cb203: MOVQ 0x40(SP), DX
         .          .    10cb208: CMPQ DX, CX
         .          .    10cb20b: MOVQ CX, BX                             ;graph.go:293
         .          .    10cb20e: CMOVG DX, CX
      20ms       20ms    10cb212: MOVQ BX, SI                             ;main.distance graph.go:285
         .          .    10cb215: SUBQ DX, BX                             ;graph.go:285
      ...
      30ms       30ms    10cb238: LEAQ 0x1(BX), R11                       ;main.distance graph.go:295
         .          .    10cb23c: CMPL R10, R9                            ;graph.go:294
      20ms       20ms    10cb23f: CMOVNE R11, BX                          ;main.distance graph.go:295
         .          .    10cb243: INCQ AX                                 ;graph.go:293
         .          .    10cb246: CMPQ CX, AX
         .          .    10cb249: JGE 0x10cb25c
      10ms       10ms    10cb24b: CMPQ SI, AX                             ;main.distance graph.go:294
         .          .    10cb24e: JAE 0x10cb273                           ;graph.go:294
         .          .    10cb250: MOVZX 0(R8)(AX*1), R9
         .          .    10cb255: CMPQ DI, AX
         .          .    10cb258: JB 0x10cb233
         .          .    10cb25a: JMP 0x10cb26b
         .          .    10cb25c: MOVQ BX, 0x50(SP)                       ;graph.go:299
         .          .    10cb261: MOVQ 0x10(SP), BP
         .          .    10cb266: ADDQ $0x18, SP
         .          .    10cb26a: RET
...
ROUTINE ======================== main.main
         ...
         .      2.53s    10cd62e: CALL main.LoadDictionary(SB)            ;main.main main.go:53
...
ROUTINE ======================== main.newIndex
      ...
      10ms       10ms    10cbf82: MOVQ BX, AX                             ;main.newIndex index.go:21
      ...
      10ms       10ms    10cbfb5: MOVQ 0x18(SP), DX                       ;main.newIndex index.go:21
         .          .    10cbfba: MOVQ 0x38(SP), BX                       ;index.go:21
      50ms       50ms    10cbfbf: MOVQ $0x0, 0x8(BX)(CX*8)                ;main.newIndex index.go:21
      10ms       10ms    10cbfc8: MOVQ $0x0, 0x10(BX)(CX*8)
      10ms       10ms    10cbfd1: LEAQ 0(BX)(CX*8), DI
         .          .    10cbfd5: CMPL $0x0, runtime.writeBarrier(SB)     ;index.go:21
         ...
         .       10ms    10cbfea: CALL runtime.gcWriteBarrier(SB)         ;main.newIndex index.go:21
...
ROUTINE ======================== runtime.main
         ...
         .      2.53s    102cd0c: CALL AX                                 ;runtime.main proc.go:203
